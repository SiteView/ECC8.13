...
BOOL ExchangeQueueName(const char * strParas, char * strReturn, int& nSize)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
//ExchangeServerState 
extern "C" _declspec(dllexport) BOOL ExchangeServerState(const char * strParas, char * szRet, int& nSize)
//(CStringList& lstParas, char* szRet)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
