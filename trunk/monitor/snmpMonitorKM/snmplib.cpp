...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
unsigned __int64 CSVSnmpOID::AvgValue(const MonitorResult &ResultList)
{
    if(!m_bSum)
    {
        m_szSumValue = 0;
    ...
    if(m_szIndexCount > 0)
        return static_cast<unsigned __int64>(m_szSumValue / m_szIndexCount);
    else
        return 0;
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
unsigned __int64 CSVSnmpOID::MaxValue(const MonitorResult &ResultList)
{
    if(!m_bSum)
    {
        m_szSumValue = 0;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
unsigned __int64 CSVSnmpOID::MinValue(const MonitorResult &ResultList)
{
    if(!m_bSum)
    {
        m_szSumValue = 0;
