...
inline void OUT_DEBUG(const char * pszTitle, const char * pszText)
{
	std::string strDbg;
	strDbg = pszTitle;
	strDbg += ": ";
...
inline void OUT_DEBUG(const char * pszTitle, const char * pszToAddr, const char * pszFromAddr, const char * pszServer, const char * pszAttach = NULL)
{
	std::string strDbg;
	strDbg = pszTitle;
	strDbg += ": ";
	...
	strDbg += pszServer;
	strDbg += "; ";
	if (NULL != pszAttach && strlen(pszAttach) > 0)
	{
		strDbg += pszAttach;
		strDbg += "; ";
	}
