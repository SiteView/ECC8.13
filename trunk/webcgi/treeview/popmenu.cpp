...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
CEccPopMenu::CEccPopMenu():
m_szMenu("")
{
    static const string szTDTR = ("<tr><td style='cursor:pointer;border:outset 1;width:100%;height:21px;background-image:url(../Images/menu0.gif);' "
        "align='center' onmouseout='this.style.backgroundImage=\\\"url(../Images/menu0.gif)\\\"' "
        "onmouseover='this.style.backgroundImage=\\\"url(../Images/menu1.gif)\\\"' onclick='parent.runmenu(\\\"");
    ...
    m_szMenu = "<SCRIPT language='JavaScript'>"
        "function showPopMenu(nodeid, rowControlString){"
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
const string CEccPopMenu::ShowMenu()
{
    return m_szMenu;
}
