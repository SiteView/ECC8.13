...
WSlot_ CEccAddMonitor2nd::slots_[] = { WSlot_("Forward()", false), WSlot_("SaveMonitor()", false), WSlot_("Cancel()", false), WSlot_("BatchAdd()", false), WSlot_("EnumDynData()", false), WSlot_("SetAlertCondition()", false), WSlot_("ContinueAdd()", false), WSlot_() };
