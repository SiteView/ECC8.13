...
public :
	...
	inline WSVMainTable * GetContentTable1()
	{
		return p_ContentTabe;
	}
	inline WTable * GetContentTable2()
	{
		return p_ContentOtherTabe;
	}
	WImage * m_pHelpimg;
private slots:
...
private:
	...
	WSVMainTable *p_ContentTabe;
	WTable *p_ContentOtherTabe;
	bool bShowHelp;	
private :
	string strTranslate;
