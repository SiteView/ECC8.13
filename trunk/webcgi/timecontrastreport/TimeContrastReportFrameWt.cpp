...
void CTimeContrastReportFrame::buildSignalMap(WSignalMap& result)
{
...
bool CTimeContrastReportFrame::triggerSlot(WObject *sender, const WSlot_ *slot, void **args)
{
  if (slot == slots_ + 0) {
...
bool CTimeContrastReportFrame::undoTriggerSlot(const WSlot_ *slot, void **args)
{
