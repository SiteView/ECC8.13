...
class CTaskList1 : public WTable
{
    //MOC: W_OBJECT CTaskList1:WTable
    W_OBJECT;
public:
    CTaskList1(WContainerWidget *parent = 0, WTable * table = 0);
	CTaskList1(WContainerWidget * parent, WSVFlexTable * table,const string helpSun);
