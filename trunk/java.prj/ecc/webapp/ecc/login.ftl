...
<div>
  ...
  <div style="float: right; width: 49%; margin-left: 5px; text-align: center;">
    <div class="screenlet">
        ...
        <div class="screenlet-body" style="text-align: center;">
          <form method="post" action="<@ofbizUrl>newuser${previousParams}</@ofbizUrl>" style="margin: 0;">
    ...
    <div class="screenlet">
        ...
        <div class="screenlet-body">
          ...
          <form method="post" action="<@ofbizUrl>setUser</@ofbizUrl>" style="margin: 0;">
            <div align="center"><input type="submit" class="smallSubmit" value="${uiLabelMap.EcommerceCheckout}"/></div>
          </form>
          <form method="post" action="<@ofbizUrl>quickAnonSetUser</@ofbizUrl>" style="margin: 0;">
