...
public class CGIRequestHandler extends com.dragonflow.HTTP.HTTPRequestHandler {
    ...
    public void handleRequest(com.dragonflow.HTTP.HTTPRequest httprequest) throws java.lang.Exception {
        ...
        java.lang.String s = com.dragonflow.Utils.I18N.toDefaultEncoding(httprequest.getValue("group"));
        ...
        if (s1.equals("perfex")) {
            ...
            for (java.util.Enumeration enumeration = array.elements(); enumeration.hasMoreElements(); outputStream.println((java.lang.String) enumeration.nextElement())) {
            }
            outputStream.println("</PRE>");
            printDebugFooter();
            ...
            for (java.util.Enumeration enumeration1 = array1.elements(); enumeration1.hasMoreElements(); outputStream.println((java.lang.String) enumeration1.nextElement())) {
            }
            outputStream.println("</PRE>");
            printDebugFooter();
            ...
            for (java.util.Enumeration enumeration2 = array2.elements(); enumeration2.hasMoreElements(); outputStream.println((java.lang.String) enumeration2.nextElement())) {
            }
            outputStream.println("</PRE>");
            printDebugFooter();
            ...
            java.lang.String s2 = com.dragonflow.Utils.I18N.UnicodeToString(httprequest.getValue("monitor"), com.dragonflow.Utils.I18N.nullEncoding());
            java.lang.String s3 = httprequest.getAccount();
            java.lang.String s4 = com.dragonflow.SiteView.Platform.getDirectoryPath("logs", s3);
            java.lang.StringBuffer stringbuffer = com.dragonflow.Utils.FileUtils.readFile(s4 + "/Operator.log");
            ...
            while ((i = stringbuffer.toString().substring(j).indexOf("\n")) > -1) {
                java.lang.String s5 = stringbuffer.toString().substring(j, j + i);
                if (s2 == null || s5.indexOf(s2) > -1 && s5.indexOf('\t') >= 0) {
                    ...
                    for (l = 0; l < (flag1 ? 2 : 7); l ++) {
                        java.lang.String s6 = com.dragonflow.Utils.I18N.StringToUnicode(s5.substring(k, s5.indexOf('\t', k)), com.dragonflow.Utils.I18N.nullEncoding());
                        if (l != 3 && l != 4 && l != 6) {
    ...
    private void printDebugHeader(com.dragonflow.HTTP.HTTPRequest httprequest, java.lang.String s) {
