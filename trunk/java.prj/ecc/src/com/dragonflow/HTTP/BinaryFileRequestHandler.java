...
public class BinaryFileRequestHandler {
    ...
    public static final java.lang.String GET_COMPRESSED_FILE = "getFileCompressed";
    ...
    public void printBody(com.dragonflow.HTTP.HTTPRequest httprequest, java.io.OutputStream outputstream) throws java.io.IOException {
        java.lang.String s = httprequest.getValue("file");
    ...
    public void printBodyForCompressed(com.dragonflow.HTTP.HTTPRequest httprequest, java.io.OutputStream outputstream) throws java.io.IOException, com.dragonflow.HTTP.HTTPRequestException {
        ...
        java.lang.String s6;
        java.lang.String s = httprequest.getValue("file");
        java.lang.String s1 = httprequest.getValue("machine");
        ...
        if (s1.equals("") || com.dragonflow.SiteView.Machine.isLocalHostname(s1)) {
            ...
            java.lang.String s2 = com.dragonflow.SiteView.Platform.closeAndConnectNetBIOSIfRemoteDefined(s);
            if (s2.length() > 0) {
            ...
            java.lang.String s3 = com.dragonflow.SiteView.Machine.REMOTE_PREFIX + machine.getProperty(com.dragonflow.SiteView.Machine.pID);
            jgl.HashMap hashmap = new HashMap();
            hashmap.put("file", s);
            java.lang.String s4 = com.dragonflow.SiteView.Machine.getCommandString("catFile", s3, hashmap);
            ...
            java.lang.String s5 = "siebelTemp_" + (new Date()).getTime() + "_" + rand.nextInt() + ".tmp";
    ...
    private void getCompressedFileLocal(java.lang.String s, java.io.OutputStream outputstream, java.lang.String s1) throws java.io.IOException, com.dragonflow.HTTP.HTTPRequestException {
        boolean flag = true;
    ...
    private boolean checkForErrors(byte abyte0[], java.lang.String s) {
        int i = s.length();
        if (i == 0) {
            return true;
        } else {
            java.lang.String s1 = new String(abyte0, 0, i + 10);
    ...
    public void printCGIHeader(com.dragonflow.HTTP.HTTPRequest httprequest, java.io.OutputStream outputstream) throws java.io.IOException {
        java.lang.String s = httprequest.generateHeader();
