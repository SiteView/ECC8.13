...
public class MasterHealth extends com.dragonflow.Health.FileBase
{
    ...
    public MasterHealth(java.lang.String s)
    {
        mgFiles = null;
        mgs = new Array();
        checks = new Array();
    ...
    public void masterHealth(java.lang.String s)
    {
        if(!s.equals(""))
        {
            groupsLocation = s;
    ...
    private void readMasterConfig()
    {
        ...
        for(int l = 0; l < mgFiles.length;l++)/*dingbing.xu add l++*/
        {
            ...
            {
                java.lang.String s = "MasterHealth.readHistoryConfig() - Error with file : " + com.dragonflow.SiteView.Platform.getRoot() + groupsLocation + java.io.File.separator + mgFiles[l];
