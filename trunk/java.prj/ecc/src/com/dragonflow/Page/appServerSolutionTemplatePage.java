...
public class appServerSolutionTemplatePage extends
    ...
    private static final java.lang.String APPLICATIONS_WINDOW = "applicationsTreeWindow";

    private static final java.lang.String APPLICATIONS_WINDOW_OPTS = "toolbar=no,width=700,height=600,directories=no,status=no,scrollbars=yes,resizable=1,menubar=no";

    private static final java.lang.String SELECTED_APPS_DIV = "SelectedModulesDIV";

    private static final java.lang.String WEBLOGIC_XSL = com.dragonflow.SiteView.Platform
            .getRoot()
            + "/templates.solutions/support/weblogic.xsl";

    private static final java.lang.String WEBSPHERE_XSL = com.dragonflow.SiteView.Platform
            .getRoot()
            + "/templates.solutions/support/websphere.xsl";

    private static final java.lang.String SHOW_APPS_TREE = "showApplicationsTree";

    private static final java.lang.String APP_SERVER_TREE_CSS = "/SiteView/htdocs/artwork/appServerTree.css";

    public static final java.lang.String WL_SERVER = "$WebLogic Server:0$";

    public static final java.lang.String WL_PORT = "$WebLogic Port:1$";

    public static final java.lang.String WL_USERNAME = "$WebLogic Username:2$";

    public static final java.lang.String WL_PASSWORD = "$WebLogic Password:3$";

    public static final java.lang.String WL_JARFILE = "$WebLogic Jar File:4$";

    public static final java.lang.String WL_SECURE = "$Secure Server:5$";

    public static final java.lang.String WS_SERVER = "$WebSphere Server:0$";

    public static final java.lang.String WS_PORT = "$WebSphere Port:1$";

    public static final java.lang.String WS_USERNAME = "$WebSphere Username:2$";

    public static final java.lang.String WS_PASSWORD = "$WebSphere Password:3$";

    public static final java.lang.String WS_DIRECTORY = "$WebSphere Directory:4$";

    public static final java.lang.String WS_CLIENT_PROPS = "$WebSphere Client Properties File:5$";

    public static final java.lang.String WS_CLASPATH = "$WebSphere Classpath:6$";
    ...
    private void mainWindowJavaScript(java.lang.String s, java.lang.String s1) {
    ...
    private void applicationsWindowJavaScript(java.lang.String s) {
        outputStream.println("<SCRIPT LANGUAGE=\"JavaScript\">\n");
        outputStream
    ...
    protected void printJavaScript() {
        java.lang.String s = "/SiteView/cgi/go.exe/SiteView?page="
    ...
    private java.lang.String showAppserverTreeWindow() {
        java.lang.String s = "selectedApps";
        applicationsWindowJavaScript(s);
        java.io.File file = null;
        java.lang.String s1 = null;
        java.lang.String s2 = "";
        if (isWebLogicSolution()) {
            java.lang.String s3 = request.getValue("$WebLogic Server:0$");
            java.lang.String s6 = request.getValue("$WebLogic Port:1$");
            java.lang.String s8 = request.getValue("$WebLogic Username:2$");
            java.lang.String s10 = request.getValue("$WebLogic Password:3$");
            java.lang.String s12 = request.getValue("$WebLogic Jar File:4$");
            java.lang.String s14 = request.getValue("$Secure Server:5$");
            ...
            java.lang.String s4 = request.getValue("$WebSphere Server:0$");
            java.lang.String s7 = request.getValue("$WebSphere Port:1$");
            java.lang.String s9 = request.getValue("$WebSphere Username:2$");
            java.lang.String s11 = request.getValue("$WebSphere Password:3$");
            java.lang.String s13 = request.getValue("$WebSphere Directory:4$");
            java.lang.String s15 = request
                    .getValue("$WebSphere Client Properties File:5$");
            java.lang.String s16 = request.getValue("$WebSphere Classpath:6$");
    ...
    private java.lang.String transformAppServerXML(java.io.File file,
            java.lang.String s) throws javax.xml.transform.TransformerException {
