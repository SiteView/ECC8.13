...
public class regularExpressionPage extends com.dragonflow.Page.CGI
{
        ...
        throws java.lang.Exception
    {
        ...
        java.lang.String s = request.getValue("_yourText");
        java.lang.String s1 = request.getValue("_yourRegExp");
        if(s1.length() <= 0)
        {
        ...
        if(s.length() > 0 && s1.length() > 2 && s1.startsWith("/"))
        {
            ...
            try
            {
                ...
                if(array.size() > 0)
                {
                    s2 = (java.lang.String)array.at(0);
                }
                if(i > 0)
                {
                    ...
                    java.lang.String s3 = com.dragonflow.Utils.TextUtils.escapeHTML(s);
                    ...
                    {
                        java.lang.String s4 = (java.lang.String)array.at(l);
                    ...
                    if(k > j)
                    {
                        ...
                        java.lang.String s5 = md5.asHex();
                        java.lang.String s6 = "start" + s5;
                        java.lang.String s7 = "end" + s5;
                        java.lang.String s8 = s.substring(0, j);
                        s8 = s8 + s6;
    ...
    private void ContentMatchError(java.lang.String s)
    {
        outputStream.println("<h2>Content Match Results</h2>");
