...
public class linkPage extends com.dragonflow.Page.CGI
{
    ...
    public static java.lang.String lookupMimeTypeString(java.lang.String s)
    {
        java.lang.String s1 = (java.lang.String)mimeTypeMap.get(s);
        if(s1 == null)
        {
            s1 = s;
        }
        ...
        throws java.lang.Exception
    {
        ...
        java.lang.String s = "Link Check Summary Report";
        ...
        } else
        {
            ...
            try
            {
                ...
                java.lang.String s4 = bufferedreader.readLine();
                if(s4 != null)
                {
            ...
            if(s2.length() == 0)
            {
                ...
                java.lang.String s5 = "/SiteView/cgi/go.exe/SiteView?page=link&file=" + s1 + "&account=" + request.getAccount();
                ...
                java.lang.String s7 = "showing error links, <a href=" + s5 + "&sort=" + request.getValue("sort") + "&show=all>show all links</a>";
                if(flag1)
                {
                    s7 = "showing all links, <a href=" + s5 + "&sort=" + request.getValue("sort") + ">show only error links</a>";
                }
                java.lang.String s8 = "checked at " + s3;
                if(flag)
                {
