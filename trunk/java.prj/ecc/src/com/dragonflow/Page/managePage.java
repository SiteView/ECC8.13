...
public class managePage extends com.dragonflow.Page.CGI
{
    ...
    private static final java.lang.String DISABLE_OP = "Disable";
    private static final java.lang.String ENABLE_OP = "Enable";
    private static final java.lang.String TEMP_ALERT_DISABLE_CHOICE = "tenp_alert_disable_choice";
    private static final java.lang.String ALERT_TEMP_DISABLE_TIMED = "timed_alert_disable";
    private static final java.lang.String ALERT_TEMP_DISABLE_SCHEDULED = "scheduled_alert_disable";
    private static final java.lang.String UNDO_ALERT_TEMP_DISABLE = "undo_temp_alert_disable";
    private static final java.lang.String DISABLE_ALERT_TIME = "disable_alert_time";
    private static final java.lang.String DISABLE_ALERT_UNITS = "disable_alert_units";
    private static final java.lang.String DISABLE_CHOICE = "disable_choice";
    private static final java.lang.String PERMANENT_DISABLE = "permanent_disable";
    private static final java.lang.String TIMED_DISABLE = "timed_disable";
    private static final java.lang.String SCHEDULED_DISABLE = "scheduled_disable";
    private static final java.lang.String UNDO_DISABLE = "undo_disable";
    private static final java.lang.String ENABLE_TEMP_ONLY = "enable_temp_only";
    private static final java.lang.String ENABLE_TEMP_ALERTS_ONLY = "enable_temp_alerts_only";
//    public static final java.lang.String TOPAZ_LOGGING_OP = com.dragonflow.SiteView.TopazInfo.getTopazNameShort() + " Logging Options";
    ...
    java.lang.String getTimedDisable(java.lang.String s)
    {
        java.lang.String s1 = "";
        java.lang.String s2 = "";
        java.lang.String s5 = "";
        if(s.equals("timed_disable"))
        {
            if(request.getValue("disableTime").length() > 0)
            {
                ...
                if(l > 0L)
                {
                    java.lang.String s8 = request.getValue("disableUnits");
                    ...
                    java.lang.String s3 = com.dragonflow.Utils.TextUtils.dateToString(l2);
                    java.lang.String s6 = com.dragonflow.Utils.TextUtils.dateToString(l2 + l * 1000L);
                    s1 = s3 + ";" + s6;
                }
            }
        } else
        if(s.equals("scheduled_disable"))
        {
            ...
            java.lang.String s4 = com.dragonflow.Utils.TextUtils.dateToString(l3 * 1000L - l1);
            java.lang.String s7 = com.dragonflow.Utils.TextUtils.dateToString(l4 * 1000L - l1);
            s1 = s4 + ";" + s7;
        }
        return s1;
    }

    java.lang.String getAlertTimedDisable()
    {
        java.lang.String s = "";
        java.lang.String s1 = "";
        ...
        java.lang.String s2 = request.getValue("tenp_alert_disable_choice");
        if(s2.equals("timed_alert_disable"))
        {
            ...
            if(l > 0L)
            {
                java.lang.String s5 = request.getValue("disable_alert_units");
        ...
        {
            java.lang.String s3 = request.getValue("startTimeDate");
            java.lang.String s4 = request.getValue("startTimeTime");
            java.lang.String s6 = request.getValue("endTimeDate");
            java.lang.String s7 = request.getValue("endTimeTime");
            if(com.dragonflow.Utils.TextUtils.isDateStringValid(s3) && com.dragonflow.Utils.TextUtils.isTimeStringValid(s4) && com.dragonflow.Utils.TextUtils.isDateStringValid(s6) && com.dragonflow.Utils.TextUtils.isTimeStringValid(s7))
            {
                ...
                java.lang.String s8 = com.dragonflow.Utils.TextUtils.dateToString(l2 * 1000L - l1);
                java.lang.String s9 = com.dragonflow.Utils.TextUtils.dateToString(l3 * 1000L - l1);
                s = s8 + ";" + s9;
            }
        } else
    ...
    private boolean isAncestor(com.dragonflow.SiteView.MonitorGroup monitorgroup, com.dragonflow.SiteView.SiteViewGroup siteviewgroup, jgl.HashMap hashmap)
    {
        ...
        java.lang.String s = com.dragonflow.Utils.I18N.toDefaultEncoding(monitorgroup.getProperty("_parent"));
        do
        {
            if(s.length() <= 0)
            {
    ...
    private com.dragonflow.SiteView.MonitorGroup findGroup(com.dragonflow.SiteView.Monitor monitor, com.dragonflow.SiteView.SiteViewGroup siteviewgroup)
    {
        ...
        {
            java.lang.String s = monitor.getProperty(com.dragonflow.SiteView.SubGroup.pGroup);
    ...
    private int addToList(java.lang.String s, com.dragonflow.SiteView.Monitor monitor, boolean flag, boolean flag1, int i, jgl.Array array, java.lang.StringBuffer stringbuffer, 
            java.lang.String s1)
    {
        boolean flag2 = false;
        if(monitor instanceof com.dragonflow.SiteView.MonitorGroup)
        ...
        java.lang.String s2 = flag2 ? "groupName" : "monitorName";
        java.lang.String s3 = flag2 ? "group" : "monitor";
        java.lang.String s4 = flag2 ? s : s1;
        java.lang.String s5 = com.dragonflow.Page.managePage.getGroupFullName(com.dragonflow.Utils.I18N.toDefaultEncoding(s));
        java.lang.String s6 = monitor.getProperty(com.dragonflow.SiteView.Monitor.pName);
        if(!flag2)
        {
            s5 = s5 + ": <B>" + s6 + "</B>";
        }
    ...
    private void doVerify(java.lang.String s)
        throws java.lang.Exception
    {
        java.lang.String s1 = com.dragonflow.Utils.I18N.toDefaultEncoding(request.getValue("toGroupID"));
        boolean flag = true;
        boolean flag1 = true;
        boolean flag2 = true;
        boolean flag3 = false;
...
label1:
                do
                {
                    ...
                    {
                        s12 = (java.lang.String)enumeration3.nextElement();
                        ...
                        while(i2 < array6.size()) 
                        {
                            ...
                            do
                            {
                                ...
                                java.lang.String s29 = (java.lang.String)array5.at(j3);
                ...
                while(j2 < array7.size()) 
                {
                    ...
                    do
                    {
                        ...
                        java.lang.String s30 = (java.lang.String)array5.at(k3);
            ...
            do
            {
                ...
                java.lang.String s31 = (java.lang.String)array5.at(k1);
                java.lang.String s37 = com.dragonflow.HTTP.HTTPRequest.decodeString(s31);
                int k4 = s37.indexOf(' ');
                ...
                if(monitorgroup == null || !isAncestor(monitorgroup, siteviewgroup, hashmap))
                {
                    ...
                    if(monitor1 != null)
                    {
                        ...
                        } else
                        {
                            ...
                            java.lang.String s49 = "SiteView/";
                            java.lang.String s50 = s6.substring(s49.length(), s6.length());
        ...
        } else
        {
            ...
            do
            {
                ...
                if(l >= 0)
                {
                    java.lang.String s11 = s8.substring(0, l);
                    java.lang.String s14 = s8.substring(l + 1);
                    if(array3.size() == 0)
                    {
                        array3.add(s11);
                    }
                    ...
                    if(monitor != null)
                    {
                        ...
                        java.lang.String s16 = "SiteView/";
                        java.lang.String s23 = s6.substring(s16.length(), s6.length());
                        ...
                        java.lang.String s25 = com.dragonflow.Page.managePage.getGroupFullName(com.dragonflow.Utils.I18N.toDefaultEncoding(s11)) + ": <B>" + monitor.getProperty(com.dragonflow.SiteView.Monitor.pName) + "</B>";
                        if(flag9)
                        {
                            java.lang.String s32 = monitor.getProperty(com.dragonflow.SiteView.Monitor.pName);
                            if(flag10)
                            {
                                s32 = "Copy of " + s32;
                            }
            ...
            do
            {
                ...
                java.lang.String s17 = (java.lang.String)enumeration4.nextElement();
            ...
            do
            {
                ...
                if(s24.length() > 0)
                {
                    ...
                    {
                        java.lang.String s33 = com.dragonflow.Utils.I18N.toDefaultEncoding(monitorgroup2.getProperty("_parent"));
                        ...
                        if(!flag15)
                        {
                            ...
                            java.lang.String s42 = com.dragonflow.Page.managePage.getGroupFullName(com.dragonflow.Utils.I18N.toDefaultEncoding(s24));
                            if(flag9)
                            {
                                java.lang.String s46 = monitorgroup2.getProperty(com.dragonflow.SiteView.Monitor.pName);
                                if(flag10)
                                {
                                    s46 = "Copy of " + s46;
                                }
        ...
        if(s.startsWith("Disable"))
        {
            ...
            java.lang.String s34 = com.dragonflow.Page.managePage.getStartTimeHTML(l3);
            java.lang.String s38 = com.dragonflow.Page.managePage.getEndTimeHTML(l3);
            ...
            if(enumeration5.hasMoreElements())
            {
                ...
                do
                {
                    ...
                    java.lang.String s47 = enumeration5.nextElement().toString();
                    if(!s47.equals(""))
                    {
        ...
        if(s.startsWith("Acknowledge"))
        {
            ...
            java.lang.String s26 = new String("");
            if(enumeration1.hasMoreElements())
            {
                s26 = (java.lang.String)enumeration1.nextElement();
            } else
            {
                java.util.Enumeration enumeration2 = request.getValues("group");
                if(enumeration2.hasMoreElements())
                {
                    s26 = (java.lang.String)enumeration2.nextElement();
                }
            }
            if(s26.length() > 0)
            {
                ...
                if(infoState != null)
                {
                    ...
                    if(obj1 != null)
                    {
                        java.lang.String s39 = obj1.toString();
                        if(s39.length() > 0)
                        {
                            ...
                            if(date1.getTime() > com.dragonflow.SiteView.Platform.timeMillis())
                            {
                                ...
                                s21 = java.lang.String.valueOf(l5);
                            }
                        }
                    }
                }
            ...
            {
                java.lang.String s35 = request.getValue("disableAlert");
                ...
                if(date.getTime() > com.dragonflow.SiteView.Platform.timeMillis())
                {
                    ...
                    s21 = java.lang.String.valueOf(l4);
                }
            }
            java.lang.String s36 = com.dragonflow.Utils.TextUtils.getValue(hashmap2, "_defaultDisableTime");
            if(s36.equals(""))
            {
                s36 = "60";
            }
            ...
            if(request.actionAllowed("_alertTempDisable"))
            {
                ...
                java.lang.String s43 = com.dragonflow.Page.managePage.getStartTimeHTML(j4);
                java.lang.String s48 = com.dragonflow.Page.managePage.getEndTimeHTML(j4);
            ...
            java.lang.String s40 = com.dragonflow.SiteView.Platform.getDirectoryPath("logs", request.getAccount());
...
//            } else
            {
                if(s.startsWith("Delete"))
                {
                    ...
                    {
                        if(((java.lang.String)array.at(l2)).equalsIgnoreCase("Health"))
                        {
        ...
        if(flag6)
        {
            ...
            java.lang.String s27 = com.dragonflow.Utils.TextUtils.getValue(hashmap3, "_defaultDisableTime");
            if(s27.equals(""))
            {
                s27 = "60";
            }
            ...
            java.lang.String s41 = com.dragonflow.Page.managePage.getStartTimeHTML(i4);
            java.lang.String s44 = com.dragonflow.Page.managePage.getEndTimeHTML(i4);
     ...
     * @param array
     */
    void completeGroupList(java.lang.String s, jgl.Array array)
    {
        try
        {
            ...
            while (enumeration.hasMoreElements())
                ...
                {
                    java.lang.String s2 = com.dragonflow.Utils.I18N.toDefaultEncoding(com.dragonflow.Utils.TextUtils.getValue(hashmap, "_group"));
                    if(s2.length() != 0)
                    {
                        array.add(s2);
...
//        printwriter.println(s);
    ...
    private void doCommit(java.lang.String s)
    {
        ...
        try
        {
            ...
            jgl.Array array2 = new Array();
            jgl.Array array3 = new Array();
            java.lang.String s2 = "something";
            java.lang.String s3 = "something";
            ...
            if(s.startsWith("Replace") || s.startsWith("Disable") || s.startsWith("Enable") || s.startsWith("Refresh"))
            {
                ...
                if(s.startsWith("Disable"))
                {
                    ...
                    java.lang.String s10 = request.getValue("tenp_alert_disable_choice");
                } else
                ...
                java.lang.String as2[] = getReplaces();
                java.lang.String s12 = "";
                ...
                if(array2.size() > 0 && !flag)
                {
                    ...
                    {
                        java.lang.String s20 = (java.lang.String)array2.at(l);
                ...
                if(array.size() > 0 && !flag)
                {
                    ...
                    {
                        java.lang.String s21 = com.dragonflow.Utils.I18N.toDefaultEncoding((java.lang.String)array.at(i1));
            ...
            if(s.startsWith("Acknowledge"))
            {
                if(isPortalServerRequest())
                {
                    ...
                    {
                        java.lang.String s4 = acknowledgeFromPortal(s);
                        if(s4 != null)
                        {
                ...
                {
                    java.lang.String s5 = request.getValue("acknowledgeComment");
                    java.lang.String s7 = getAlertTimedDisable();
                    java.lang.String as1[] = getReplaces();
                    java.lang.String s11 = request.getUsername();
                    if(s11.length() == 0)
                    {
                    ...
                    if(array2.size() > 0)
                    {
                        ...
                        {
                            java.lang.String s13 = (java.lang.String)array2.at(j);
                            if(s7.length() > 0)
                            {
                            ...
                            } else
                            {
                                ...
                                if(infoMonitor != null)
                                {
                                    java.lang.String s16 = infoMonitor.getProperty(com.dragonflow.SiteView.Monitor.pAcknowledgeAlertDisabled);
                                    if(s16.length() > 0)
                                    {
                    ...
                    if(array.size() > 0)
                    {
                        ...
                        {
                            java.lang.String s14 = com.dragonflow.Utils.I18N.toDefaultEncoding((java.lang.String)array.at(k));
                            try
                            {
                            ...
                            java.lang.String s19 = (java.lang.String)hashmap.get("_parent");
                            ...
                            for(int j1 = 1; j1 < array6.size(); j1++)
                            {
                                ...
                                java.lang.String s22 = (java.lang.String)hashmap1.get("_group");
...
//            } else
     ...
     * @return
     */
    private boolean groupPassFilter(java.lang.String s)
    {
        try {
     ...
     * @return
     */
    private boolean monitorPassFilter(java.lang.String s)
    {
        try {
        com.dragonflow.SiteView.AtomicMonitor atomicmonitor;
        int i = s.indexOf(' ');
    ...
    private jgl.Array getFilteredGroupList()
    {
        ...
        do
        {
            ...
            java.lang.String s = monitorgroup.getProperty(com.dragonflow.SiteView.Monitor.pID);
    ...
    {
        java.lang.String s = request.getValue("monitorTypeSelect");
        java.lang.String s1 = request.getValue("monitorNameSelect");
        java.lang.String s2 = request.getValue("machineNameSelect");
        if(s1.length() > 0)
        {
            java.lang.String s3 = atomicmonitor.getProperty(com.dragonflow.SiteView.Monitor.pName) + atomicmonitor.getProperty(com.dragonflow.SiteView.Monitor.pDescription);
            jgl.Array array = new Array();
        ...
        if(s2.length() > 0)
        {
            java.lang.String s4 = atomicmonitor.getHostname();
            jgl.Array array1 = new Array();
        ...
        return s.length() <= 0 || s.indexOf((java.lang.String)atomicmonitor.getClassProperty("class")) != -1;
    }

    private void printMonitorGroupTable(java.lang.String s, boolean flag, jgl.Array array, boolean flag1, boolean flag2, jgl.Array array1, boolean flag3)
    {
        ...
        for(int i = 0; i < array.size(); i++)
        {
            ...
            {
                outputStream.print((java.lang.String)array.at(i) + (flag2 ? "" : "<font color=red> Not Permitted</font>"));
            }
    ...
    boolean exceedsLicenseLimit(jgl.Array array, java.lang.String s)
    {
        boolean flag = com.dragonflow.Utils.LUtils.wouldExceedLimit(array, s);
        if(flag)
        {
            java.lang.String s1 = com.dragonflow.Utils.LUtils.getLicenseExceededHTML();
            outputStream.println(s1);
        }
        return flag;
    }

    public void manageMonitors(jgl.Array array, jgl.Array array1, java.lang.String s, boolean flag, java.lang.String as[])
        throws java.lang.Exception
    {
        if(!flag)
        {
        ...
        for(int i = 0; i < array.size(); i++)
        {
            ...
            java.lang.String s4 = s1.replace(' ', '/');
            array3.add(s4);
            if(debug)
            {
...
//            }
        ...
        java.lang.String s3 = com.dragonflow.Utils.TextUtils.getValue(hashmap, "_nextID");
        if(s3.length() == 0)
        {
            s3 = "1";
        }
        ...
        if(flag)
        {
            for(int k = 0; k < array2.size(); k++)
            {
                ...
                atomicmonitor.notifyMove((java.lang.String)array3.at(k));
//                if(com.dragonflow.SiteView.TopazConfigurator.configInTopazAndRegistered())
//                {
//                    java.lang.String s7 = "SiteView/" + s + "/" + atomicmonitor.getFullID();
...
//                }
    ...
    public void manageGroups(jgl.Array array, jgl.Array array1, java.lang.String s, boolean flag, java.lang.String as[])
        throws java.lang.Exception
    {
        jgl.Array array2 = new Array();
        jgl.Array array3 = new Array();
        for(int i = 0; i < array.size(); i++)
        {
            java.lang.String s1 = com.dragonflow.Utils.I18N.toDefaultEncoding((java.lang.String)array.at(i));
            java.lang.String s2 = (java.lang.String)array1.at(i);
            if(debug)
            {
            ...
            java.lang.String s4 = com.dragonflow.Utils.I18N.toDefaultEncoding(com.dragonflow.Utils.TextUtils.getValue(hashmap1, "_parent"));
            ...
            if(!flag)
            {
                ...
                {
                    com.dragonflow.SiteView.SiteViewGroup.updateStaticPages((java.lang.String)array7.at(l));
                }
...
//            com.dragonflow.SiteView.TopazConfigurator.moveGroupInTopaz(s1, s);
    ...
    private boolean overRemoteMonitorsLimit(java.lang.String s, jgl.Array array)
    {
        com.dragonflow.SiteView.SiteViewGroup siteviewgroup = com.dragonflow.SiteView.SiteViewGroup.currentSiteView();
        ...
        for(int l = 0; l < array.size(); l++)
        {
            ...
            java.lang.String s2 = (java.lang.String)hashmap.get("_class");
            if(s2.equals("URLRemoteMonitor"))
            {
                i++;
                if(hashmap.get("_getImages") != null && ((java.lang.String)hashmap.get("_getImages")).equals("on") || hashmap.get("_getFrames") != null && ((java.lang.String)hashmap.get("_getFrames")).equals("on"))
                {
                    k++;
                }
            }
        ...
        java.lang.String s3 = com.dragonflow.SiteView.monitorUtils.getPermission(hashmap1, "_monitorType", "URLRemoteMonitor");
        int i1;
        ...
        java.lang.String s4 = com.dragonflow.SiteView.monitorUtils.getPermission(hashmap1, "_monitorType", "URLRemoteSequenceMonitor");
        int j1;
        ...
        java.lang.String s5 = com.dragonflow.Utils.TextUtils.getValue(hashmap1, "_maximumFAndIMonitors");
    ...
    private int countFAndIMonitors(java.lang.String s)
    {
        int i = 0;
        try
        {
            ...
            do
            {
                ...
                if(s2.startsWith("URLRemote") && (hashmap1.get("_getImages") != null && ((java.lang.String)hashmap1.get("_getImages")).equals("on") || hashmap1.get("_getFrames") != null && ((java.lang.String)hashmap1.get("_getFrames")).equals("on")))
                {
                    i++;
                }
            } while(true);
    ...
    private boolean overMaximumMonitors(java.lang.String s, int i)
    {
        com.dragonflow.SiteView.SiteViewGroup siteviewgroup = com.dragonflow.SiteView.SiteViewGroup.currentSiteView();
        com.dragonflow.SiteView.MonitorGroup monitorgroup = (com.dragonflow.SiteView.MonitorGroup)siteviewgroup.getElement(s);
    ...
    private boolean overUrlLocationsMax(java.lang.String s, jgl.Array array)
    {
        com.dragonflow.SiteView.SiteViewGroup siteviewgroup = com.dragonflow.SiteView.SiteViewGroup.currentSiteView();
        ...
        for(int j = 0; j < array.size(); j++)
        {
            ...
            java.lang.String s1 = (java.lang.String)hashmap.get("_class");
            ...
            do
            {
                ...
                java.lang.String s3 = (java.lang.String)com.dragonflow.Utils.HTTPUtils.locationMap.get(s2);
                if(s3 != null && !s3.equals(""))
                {
                    ...
                    {
                        java.lang.String s4 = monitorgroup.getSetting("_allowInvalidNode");
                        java.lang.String s5 = com.dragonflow.Utils.HTTPUtils.getLocationID(s3);
    ...
    jgl.Array duplicateGroupFile(java.lang.String s, jgl.Array array, jgl.HashMap hashmap, java.lang.String as[], jgl.Array array1)
        throws java.lang.Exception
    {
        if(debug)
        {
        ...
        for(int i = 1; i < array.size(); i++)
        {
            ...
            {
                java.lang.String s1 = com.dragonflow.Utils.I18N.toDefaultEncoding(com.dragonflow.Utils.TextUtils.getValue(hashmap2, "_group"));
                ...
                try
                {
                    ...
                    if(array2.size() > 0)
                    {
                        ...
                        java.lang.String s2 = com.dragonflow.Utils.TextUtils.getValue(hashmap3, "_name");
    ...
    java.lang.String getReturnURL(boolean flag)
    {
        java.lang.String s = "";
        if(flag)
        {
        ...
        throws java.lang.Exception
    {
        ...
        java.lang.String s1 = s + java.io.File.separator + "tree.dyn";
        ...
        } else
        {
            ...
            java.lang.String s3 = request.getAccount();
            for(int i = 0; i < array.size(); i++)
            {
            ...
            do
            {
                ...
                java.lang.String s4 = com.dragonflow.HTTP.HTTPRequest.decodeString((java.lang.String)enumeration.nextElement(), com.dragonflow.Utils.I18N.nullEncoding());
                if(s4.startsWith(OPEN_VARIABLE))
                {
                    java.lang.String s5 = s4.substring(OPEN_VARIABLE.length(), s4.length() - 2);
                    if(debug)
                    {
                ...
                {
                    java.lang.String s6 = s4.substring(CLOSE_VARIABLE.length(), s4.length() - 2);
                    if(debug)
                    {
            ...
            if(com.dragonflow.Page.treeControl.useTree())
            {
                ...
                {
                    s7 = com.dragonflow.HTTP.HTTPRequest.decodeString((java.lang.String)enumeration1.nextElement());
                ...
                {
                    s8 = com.dragonflow.HTTP.HTTPRequest.decodeString((java.lang.String)enumeration2.nextElement());
            ...
            } else
            {
                ...
                {
                    java.lang.String s9 = (java.lang.String)enumeration6.nextElement();
...
//        }
    ...
    void printManageButton(java.lang.String s, java.lang.String s1, java.lang.String s2)
    {
    ...
    {
        java.lang.String s = com.dragonflow.SiteView.Platform.getURLPath("htdocs", request.getAccount()) + "/Detail";
        com.dragonflow.SiteView.SiteViewGroup siteviewgroup = com.dragonflow.SiteView.SiteViewGroup.currentSiteView();
        ...
        if(array1.size() > 0)
        {
            ...
            for(int j = 0; j < array1.size(); j++)
            {
                ...
                java.lang.String s2 = monitor1.getOwner().getProperty(com.dragonflow.SiteView.Monitor.pID) + " " + monitor1.getProperty(com.dragonflow.SiteView.Monitor.pID);
    ...
    private void printGroup(com.dragonflow.SiteView.MonitorGroup monitorgroup, jgl.HashMap hashmap, jgl.HashMap hashmap1, int i)
    {
        ...
        java.lang.String s2 = com.dragonflow.SiteView.Platform.getURLPath("htdocs", request.getAccount()) + "/Detail";
        outputStream.print("<TR><TD>");
        ...
        if(flag)
        {
            ...
            do
            {
                ...
                if(monitor instanceof com.dragonflow.SiteView.SubGroup)
                {
                    java.lang.String s3 = com.dragonflow.Utils.I18N.toDefaultEncoding(monitor.getProperty(com.dragonflow.SiteView.SubGroup.pGroup));
                    com.dragonflow.SiteView.SiteViewGroup siteviewgroup = com.dragonflow.SiteView.SiteViewGroup.currentSiteView();
                ...
                } else
                {
                    outputStream.print("<TR><TD>");
                    outputStream.print(s1);
                    java.lang.String s4 = s + " " + monitor.getProperty(com.dragonflow.SiteView.Monitor.pID);
...
//        }
        ...
        throws java.lang.Exception
    {
        ...
        com.dragonflow.SiteView.SiteViewGroup siteviewgroup = com.dragonflow.SiteView.SiteViewGroup.currentSiteView();
        jgl.Array array2 = new Array();
        java.lang.String s = "administrator";
        Object obj = null;
        Object obj1 = null;
        Object obj2 = null;
        Object obj3 = null;
...
label0:
        for(int j = 0; j < array.size(); j++)
        {
            ...
            java.lang.String s3 = as[0] + com.dragonflow.SiteView.SiteViewGroup.ID_SEPARATOR + as[1];
...
label1:
        ...
        {
            java.lang.String s2 = (java.lang.String)array1.at(k);
...
label2:
        ...
        for(int j1 = 0; j1 < array2.size(); j1++)
        {
            ...
            java.lang.String s4 = monitor2.getProperty(com.dragonflow.SiteView.Monitor.pGroupID);
            java.lang.String s5 = monitor2.getProperty(com.dragonflow.SiteView.Monitor.pID);
            ...
            java.lang.String s6 = com.dragonflow.SiteView.Monitor.pBaselineMean.getName();
            com.dragonflow.SiteView.Monitor _tmp1 = monitor2;
            java.lang.String s7 = com.dragonflow.SiteView.Monitor.pBaselineStdDev.getName();
            com.dragonflow.SiteView.Monitor _tmp2 = monitor2;
            java.lang.String s8 = com.dragonflow.SiteView.Monitor.pBaselineDate.getName();
            java.lang.Long long1 = new Long(com.dragonflow.SiteView.Platform.timeMillis());
            java.lang.String s9 = long1.toString();
    ...
    public static jgl.HashMap copyHashMap(jgl.HashMap hashmap)
    {
        ...
        for(java.util.Enumeration enumeration = hashmap.keys(); enumeration.hasMoreElements();)
        {
            ...
            if(hashmap.get(obj1) instanceof jgl.Array)
            {
                ...
                for(int i = 0; i < array.size(); i++)
                {
                    array1.add(new String((java.lang.String)array.at(i)));
                }
    ...
    public void performGroupConfigChange(java.lang.String s, java.lang.String s1, java.lang.String as[], java.lang.String s2, java.lang.String s3, java.lang.String s4)
        throws java.lang.Exception
    {
        if(s.equals("_master"))
        {
        ...
        jgl.Array array = getGroupFrames(s);
        java.lang.String s5 = com.dragonflow.Page.managePage.getGroupName(array, s);
        if(debug)
        {
        ...
        for(int i = 1; i < array.size(); i++)
        {
            ...
            java.lang.String s7 = com.dragonflow.Utils.TextUtils.getValue(hashmap, "_class");
            if(s7.equals("SubGroup"))
            {
                java.lang.String s8 = com.dragonflow.Utils.I18N.toDefaultEncoding(com.dragonflow.Utils.TextUtils.getValue(hashmap, "_group"));
                if(s8.length() != 0)
                {
    ...
    void refreshMonitor(java.lang.String s, java.lang.String s1, java.lang.String s2)
    {
        com.dragonflow.Utils.I18N.test(s, 0);
        java.lang.String s3 = s + com.dragonflow.SiteView.SiteViewGroup.ID_SEPARATOR + s1;
        com.dragonflow.SiteView.SiteViewGroup siteviewgroup = com.dragonflow.SiteView.SiteViewGroup.currentSiteView();
        com.dragonflow.SiteView.Monitor monitor = (com.dragonflow.SiteView.Monitor)siteviewgroup.getElement(s3);
        java.lang.String s4 = "0";
    ...
    public void performMonitorConfigChange(java.lang.String s, java.lang.String s1, java.lang.String as[], java.lang.String s2, java.lang.String s3, java.lang.String s4)
        throws java.lang.Exception
    {
        int i = s.indexOf(' ');
        if(i >= 0)
        {
            ...
            java.lang.String s5 = s.substring(0, i);
            java.lang.String s6 = s.substring(i + 1);
            jgl.Array array = getGroupFrames(s5);
            jgl.HashMap hashmap = com.dragonflow.Page.managePage.findMonitor(array, s6);
            java.lang.String s7 = (java.lang.String)hashmap.get("_class");
            if(s7 != null && s7.equals("SubGroup"))
            {
                java.lang.String s8 = (java.lang.String)hashmap.get("_group");
                performGroupConfigChange(s8, s1, as, s2, s3, s4);
            } else
            {
    ...
    private void performMonitorConfigChange(jgl.HashMap hashmap, java.lang.String s, java.lang.String s1, java.lang.String s2, java.lang.String s3, java.lang.String s4, java.lang.String as[])
    {
        com.dragonflow.SiteView.SiteViewGroup siteviewgroup = com.dragonflow.SiteView.SiteViewGroup.currentSiteView();
        java.lang.String s5 = com.dragonflow.Utils.TextUtils.getValue(hashmap, "_class");
        java.lang.String s6 = com.dragonflow.Utils.TextUtils.getValue(hashmap, "_id");
        boolean flag = false;
    ...
    public static void acknowledgeLog(java.lang.String s, java.lang.String s1, java.lang.String s2, java.lang.String s3, java.lang.String s4, java.lang.String s5, java.lang.String s6)
    {
        com.dragonflow.Log.LogManager.log("Operator", s + "\t" + s1 + "\t" + s2 + "\t" + s3 + "\t" + s4 + "\t" + s5 + "\t" + s6);
    }

    private void getMonitorInfo(java.lang.String s)
        throws java.lang.Exception
    {
        if(s == null)
        {
        ...
        if(i >= 0)
        {
            java.lang.String s1 = com.dragonflow.Utils.I18N.toDefaultEncoding(s.substring(0, i));
            java.lang.String s2 = s.substring(i + 1);
            jgl.Array array = getGroupFrames(s1);
    ...
    private void acknowledgeProperties(com.dragonflow.SiteView.Monitor monitor, java.lang.String s, java.lang.String s1, java.lang.String s2, java.lang.String s3, boolean flag)
    {
        if(flag)
        {
            java.lang.String s4 = monitor.getProperty(com.dragonflow.SiteView.Monitor.pCategory);
    ...
    public void acknowledgeMonitor(java.lang.String s, java.lang.String s1, java.lang.String s2, java.lang.String s3, java.lang.String s4, boolean flag)
        throws java.lang.Exception
    {
        if(s1.length() <= 0)
        {
        ...
        if(infoMonitor != null)
        {
            java.lang.String s5 = com.dragonflow.Utils.TextUtils.getValue(infoState, "_class");
            if(s5.equals("SubGroup"))
            {
                java.lang.String s6 = com.dragonflow.Utils.I18N.toDefaultEncoding(com.dragonflow.Utils.TextUtils.getValue(infoState, "_group"));
    ...
    public void acknowledgeGroup(java.lang.String s, java.lang.String s1, java.lang.String s2, java.lang.String s3, java.lang.String s4, boolean flag)
        throws java.lang.Exception
    {
        jgl.Array array = null;
        try
        ...
        {
            jgl.HashMap hashmap = (jgl.HashMap)array.at(i);
            java.lang.String s6 = com.dragonflow.Utils.TextUtils.getValue(hashmap, "_class");
            if(s6.equals("SubGroup"))
            {
                java.lang.String s7 = com.dragonflow.Utils.I18N.toDefaultEncoding(com.dragonflow.Utils.TextUtils.getValue(hashmap, "_group"));
                if(s7.length() != 0)
                {
                    acknowledgeGroup(s7, s1, s2, s3, s4, flag);
                }
            }
            java.lang.String s8 = com.dragonflow.Utils.TextUtils.getValue(hashmap, "_id");
            acknowledgeMonitor(s + " " + s8, s1, s2, s3, s4, flag);
        }

    }

    private java.lang.String acknowledgeFromPortal(java.lang.String s)
    {
        ...
        java.lang.String s1 = "http://" + siteviewobject.getProperty("_server") + "/SiteView/cgi/go.exe/SiteView";
        java.lang.String s2 = "";
        java.lang.String s3 = "";
        java.lang.String s4 = request.getValue("account");
        ...
        } else
        {
            ...
            java.lang.StringBuffer stringbuffer = new StringBuffer();
            long l = 50000L;
            java.lang.String s5 = new String("");
    ...
    {
        java.lang.String s = request.getValue("portalserver");
    ...
    private java.util.Enumeration getExistingSchedule(com.dragonflow.SiteView.SiteViewGroup siteviewgroup)
    {
        ...
        for(java.util.Enumeration enumeration = request.getValues("group"); enumeration.hasMoreElements();)
        {
            ...
            {
                java.lang.String s2 = enumeration2.nextElement().toString();
                java.lang.String s5 = hashmap1.get(s2).toString();
        ...
        while(enumeration1.hasMoreElements()) 
        {
            ...
            if(i >= 0)
            {
                ...
                java.lang.String s7 = s1.substring(i + 1);
                java.lang.String s8 = getExistingMonitorSchedule(s4, s7, siteviewgroup);
                jgl.HashMap hashmap2 = new HashMap();
                ...
                } else
                {
                    try
                    {
                        ...
                        java.lang.String s9 = com.dragonflow.Utils.I18N.toDefaultEncoding(monitor.getProperty("_group"));
                    ...
                    {
                        java.lang.String s10 = enumeration3.nextElement().toString();
                        java.lang.String s11 = hashmap2.get(s10).toString();
    ...
    private java.lang.String getExistingMonitorSchedule(java.lang.String s, java.lang.String s1, com.dragonflow.SiteView.SiteViewGroup siteviewgroup)
    {
        java.lang.String s2 = "";
        java.lang.String s3 = "";
        java.lang.String s5 = "";
        ...
        if(!s6.equals("SubGroup"))
        {
            ...
            {
                java.lang.String s4 = monitor.getProperty("_name");
                int i = s2.indexOf(";");
                java.lang.String s7 = s2.substring(0, i);
                java.lang.String s8 = s2.substring(i + 1);
    ...
    private jgl.HashMap getExistingGroupSchedule(java.lang.String s, com.dragonflow.SiteView.SiteViewGroup siteviewgroup)
        throws java.lang.Exception
    {
        jgl.Array array = null;
        jgl.HashMap hashmap = new HashMap();
...
label0:
        ...
        {
            jgl.HashMap hashmap1 = (jgl.HashMap)array.at(i);
            java.lang.String s1 = com.dragonflow.Utils.TextUtils.getValue(hashmap1, "_class");
            if(s1.equals("SubGroup"))
            {
                java.lang.String s2 = com.dragonflow.Utils.TextUtils.getValue(hashmap1, "_group");
                if(s2.length() == 0)
                {
                    continue;
                }
            ...
            java.lang.String s3 = com.dragonflow.Utils.TextUtils.getValue(hashmap1, "_id");
            if(s3.equals(""))
            {
                continue;
            }
            java.lang.String s4 = getExistingMonitorSchedule(s, s3, siteviewgroup);
