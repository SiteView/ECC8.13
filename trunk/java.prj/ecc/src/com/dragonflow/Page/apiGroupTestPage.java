        ...
        throws java.lang.Exception
    {
        try
        {
            ...
            if(request.getValue("testName").equals("createGroupProperties"))
            {
                try
                {
                    java.lang.String s = request.getValue("createGroupName");
                    java.lang.String s14 = request.getValue("createParentGroupID");
                    ...
                    for(int l = 0; l < asspropertydetails2.length; l++)
                    {
                        ...
                        {
                            java.lang.String s27 = asspropertydetails2[l].getDefaultValue();
            ...
            if(request.hasValue("testName") && request.getValue("testName").equals("createGroup"))
            {
                try
                {
                    java.lang.String s1 = request.getValue("createGroupName");
                    ...
                    outputStream.println("<input type=hidden name=\"page\" value=\"apiGroupTest\">");
                    outputStream.println("<input type=hidden name=\"account\" value=\"administrator\">");
                    java.lang.String s23 = request.getValue("createGroupProperties");
                    java.lang.String as1[] = splitString(s23, "\n");
                    int i1 = 0;
            ...
            {
                java.lang.String s2 = request.getValue("editGroupID");
                try
                {
            ...
            if(request.hasValue("testName") && request.getValue("testName").equals("editGroup"))
            {
                try
                {
                    java.lang.String s3 = request.getValue("editGroupID");
                    java.lang.String s16 = request.getValue("editGroupProperties");
                    java.lang.String as[] = splitString(s16, "\n");
                    int j = 0;
            ...
            if(request.hasValue("testName") && request.getValue("testName").equals("delete"))
            {
                try
                {
                    java.lang.String s4 = request.getValue("groupID");
            ...
            {
                java.lang.String s5 = request.getValue("grpMoveGroupID");
            ...
            {
                java.lang.String s6 = request.getValue("grpCopyGroupID");
                java.lang.String s18 = null;
            ...
            if(request.hasValue("testName") && request.getValue("testName").equals("listGroupPropertiesDetails"))
            {
                try
                {
                    java.lang.String s7 = request.getValue("listGroupPropertiesOperation");
            ...
            if(request.hasValue("testName") && request.getValue("testName").equals("listGroupPropertyDetails"))
            {
                try
                {
                    java.lang.String s8 = request.getValue("getClassPropertyName");
            ...
            if(request.hasValue("testName") && request.getValue("testName").equals("listGroupInstancePropertyDetails"))
            {
                try
                {
                    java.lang.String s9 = request.getValue("getGroupInstancePropertyName");
                    java.lang.String s19 = request.getValue("getGroupInstanceGroupID");
                    outputStream.println("<p>List of the properties of a group:</p>\n");
            ...
            {
                java.lang.String s10 = request.getValue("getGroupInstancesGroupID");
                ...
                } else
                {
                    try
                    {
                        java.lang.String s20 = request.getValue("getGroupInstancesOperation");
            ...
            if(request.hasValue("testName") && request.getValue("testName").equals("listInstanceProperties"))
            {
                try
                {
                    java.lang.String s11 = request.getValue("getInstancePropertiesGroupID");
                    java.lang.String s21 = request.getValue("getInstancePropertiesOperation");
            ...
            if(request.hasValue("testName") && request.getValue("testName").equals("listInstanceProperty"))
            {
                try
                {
                    java.lang.String s12 = request.getValue("getInstancePropertyGroupID");
                    java.lang.String s22 = request.getValue("getInstancePropertyName");
                    java.lang.String s25 = request.getValue("getInstancePropertyOperation");
            ...
            if(request.hasValue("testName") && request.getValue("testName").equals("listChildGroups"))
            {
                ...
                java.lang.String s13 = request.getValue("parentGroupID");
