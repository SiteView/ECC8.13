...
public class developerNotePage extends com.dragonflow.Page.CGI
{
    ...
    private static java.lang.String NOTE_CACHE_FILENAME = com.dragonflow.SiteView.Platform.getRoot() + "/htdocs/developerNoteList.html";
        ...
        throws java.io.IOException
    {
        ...
        if(request.isPost())
        {
            ...
            if(s6.length() == 0)
            {
                ...
                java.lang.String s9 = com.dragonflow.Utils.TextUtils.getValue(hashmap1, "_developerNoteNextID");
        ...
        java.lang.String s2 = s + " Developer Note";
        printBodyHeader(s2);
        if(obj == null)
        {
        ...
        java.lang.String s14 = com.dragonflow.Page.developerNotePage.getOptionsHTML(array1, s12);
        ...
        java.lang.String s17 = com.dragonflow.Page.developerNotePage.getOptionsHTML(array2, s16);
        ...
        throws java.lang.Exception
    {
        ...
        java.lang.String s = com.dragonflow.Utils.TextUtils.getValue(hashmap, "_developerNoteSourcePath");
        if(s.length() == 0)
        {
