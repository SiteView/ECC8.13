 ...
 */
public class OracleDbValidationInfo extends DbValidationInfo {

	private DbReservedWords m_ReservedDbWords = new DbReservedWords();
	private IDataTypeResolver m_Resolver = DataTypeResolverFactory.Create(DatabaseEngine.Oracle);
