...
public class TestFunc
{
	...
	public RetMapInMap test88(HashMap<String, String> inwhat)
	{
		try
		{
	...
	public RetMapInMap test89(HashMap<String, String> inwhat)
	{
		...
		fmap.put("return", ndata1);
		System.out.println(" Sent out "+count+" mail.  J ");
		System.out.println("EccService GetUnivData dowhat: EmailTest\n                         /ret: " + ret + "   run:" + (float) (System.currentTimeMillis() - start) / 1000 + " s");
		return new RetMapInMap(ret, estr.toString(), fmap);	
	}
