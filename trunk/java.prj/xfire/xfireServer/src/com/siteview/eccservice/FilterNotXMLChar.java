...
public class FilterNotXMLChar
{
	...
	public static void FilterMapInVector(Vector<HashMap<String, String>> fmap, StringBuilder estr)
	{
		if (fmap == null)
			return;
		try
	...
	public static void FilterMapInMap(HashMap<String, HashMap<String, String>> fmap, StringBuilder estr)
	{
		if (fmap == null)
			return;
		try
	...
	public static void FilterMap(String key, HashMap<String, String> ndata, StringBuilder estr)
	{
		if (ndata == null)
			return;
