...
public class ServletECC extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
	{
		...
		System.out.println("  " + date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds() + "(h:m:s) doPost: " + pinfo);		
		...
		if (len < 300)
			...
			System.out.println("    Lenght of incoming data by post: " + len);
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
	{
		...
		Date date = new Date();
		String pinfo= request.getPathInfo();
		System.out.print("  " + date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds() + "(h:m:s): " );
		int len = pinfo.length();
		if (len < 300)
			System.out.println("    " + pinfo);
		else
			System.out.println("    Lenght of PathInfo: " + len);		
	...
	public String getData()
	{
		...
		} catch (Exception e)
		{
			...
			System.out.println(" 当前目录是： "+ properties.getProperty("user.dir"));   
	...
	public void PrintData2(PrintWriter out)
	{
		...
		Vector<HashMap<String, String>> fmap = vmap.getVmap();
		
		boolean first1 = true;
		StringBuilder ret= new StringBuilder("[");
		for (int key = 0; key < fmap.size(); ++key)
		{
			HashMap<String, String> ndata = fmap.get(key);
...
//			e.printStackTrace();
	...
	public void PrintData(String startstr, PrintWriter out, HashMap<String, String> inwhat,HashMap<String, HashMap<String, String>> infmap)
	{
		if(service==null)
		{
//			Date date = new Date();
//			System.out.println("  new an EccService at:"+ date.getHours() + "h " + date.getMinutes() + "m " + date.getSeconds()+"s");
			service = new EccService();
		}
		...
		if (startstr.equalsIgnoreCase("/submitunivdata/"))
		{
			...
			HashMap<String, HashMap<String, String>> fmap = rmap.getFmap();
		...
		if (startstr.equalsIgnoreCase("/getforestdata/"))
		{
			...
			Vector<HashMap<String, String>> vmap = rmap.getVmap();
