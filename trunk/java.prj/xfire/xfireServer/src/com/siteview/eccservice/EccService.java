...
{
	private final static Logger log = Logger.getLogger(EccService.class.getName());
	...
	static{
		try {
			System.setOut(new PrintStream(new FileOutputStream(new File("ConsoleOutput.log"))));
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Press key enter to end...");
...
//			System.out.println("start pre-caching all template data ...");
...
//			}
	...
	private void SetStaticVar(boolean show)
	{
		try
		{
			...
			if (show)
			{
				System.out.println("SetDowhatVersion: " + dowhatVer);
				System.out.println("SetPreCacheTemplateBean: " + precacheTPL);
				System.out.println("enableHttpGetJson: " + enableHttpGetJson);
				
				System.out.println("adminPassword: \"" + admin+ "\"   md5-digest: "+adminMd5);
				System.out.println(" userPassword: \"" + user + "\"   md5-digest: "+userMd5);
			}
	...
	public RetMapInMap GetUnivData(HashMap<String, String> inwhat)
	{
		...
		System.out.println("EccService GetUnivData dowhat: " + dowhat + "                         /ret: " + ret + "   run:" + (float) (System.currentTimeMillis() - start) / 1000 + " s");
	...
	public RetMapInMap SubmitUnivData(HashMap<String, HashMap<String, String>> fmap, HashMap<String, String> inwhat)
	{
		...
		System.out.println("EccService SubmitUnivData dowhat: " + dowhat + "                         /ret: " + ret + "   run:" + (float) (System.currentTimeMillis() - start) / 1000 + " s");
		return new RetMapInMap(ret, estr.toString(), fmap);
	}
	...
	public RetMapInVector GetForestData(HashMap<String, String> inwhat)
	{
		...
		System.out.println("EccService GetForestData dowhat: " + dowhat + "                         /ret: " + ret + "   run:" + (float) (System.currentTimeMillis() - start) / 1000 + " s");
