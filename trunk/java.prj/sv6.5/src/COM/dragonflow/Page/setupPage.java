...
public class setupPage extends COM.dragonflow.Page.CGI
{
    ...
    void doInitialSetup()
    {
        ...
        if(request.getValue("operation").indexOf("Examples") != -1)
        {
            ...
            if(!COM.dragonflow.SiteView.Platform.isWindows())
            {
                ...
                do
                {
                    ...
                    do
                    {
                        ...
                        java.lang.String s4 = (java.lang.String)enumeration2.nextElement();
            ...
            {
                java.lang.System.err.println("failed to find 'HEARTBEAT' process to monitor");
            }
            hashmap.put("_nextID", "" + i);
...
label0:
                for(int l = 0; l < as2.length; l++)
                {
                    ...
                    do
                    {
                        ...
                        s5 = (java.lang.String)enumeration3.nextElement();
            ...
            try
            {
                ...
                {
                    java.lang.String s1 = (java.lang.String)vector.elementAt(j);
                    java.lang.String s3 = "Disk space on " + vector.elementAt(j + 1);
                    hashmap1 = new HashMap();
                    hashmap1.put("_id", "" + i++);
            ...
            {
                java.lang.System.err.println("Unable to retrieve disks: " + siteviewexception.getMessage());
            }
            hashmap1 = new HashMap();
            hashmap1.put("_id", "" + i++);
            ...
            {
                array5.add(createDailyFrame(i1++, (java.lang.String)array.at(j1)));
                array5.add(createWeeklyFrame(i1++, (java.lang.String)array.at(j1)));
            }

            writeFrameFile(array5, "history", "config");
            COM.dragonflow.SiteView.SiteViewGroup siteviewgroup = COM.dragonflow.SiteView.SiteViewGroup.currentSiteView();
            siteviewgroup.setProperty("_nextReportID", java.lang.String.valueOf(java.lang.Math.max(i1, 10)));
        ...
        try
        {
            ...
            if(request.isPost())
            {
                if(request.getValue("licenseAccepted").length() > 0)
                {
                    ...
                    {
                        java.lang.String s = updateMCSettings();
            ...
            {
                java.lang.String s1 = (java.lang.String)hashmap.get("_productName");
                if(s1.length() > 0)
                {
                    s1 = (java.lang.String)hashmap.get("_productName");
                } else
                {
                    s1 = "SiteView";
                }
                ...
                } else
                {
                    ...
                    java.lang.StringBuffer stringbuffer = COM.dragonflow.Utils.FileUtils.readCharFile(COM.dragonflow.SiteView.Platform.getRoot() + java.io.File.separator + "templates.view" + java.io.File.separator + (java.lang.String)hashmap.get("_startupPage") + ".txt");
                    ...
                    for(java.util.Enumeration enumeration = hashmap.values("_showWizardLink"); enumeration.hasMoreElements();)
                    {
                        ...
                        java.lang.String s3 = "COM.dragonflow.StandardMonitor." + s2 + "Monitor";
                        ...
                        try
                        {
                            ...
                            {
                                java.lang.StringBuffer stringbuffer1 = COM.dragonflow.Utils.FileUtils.readCharFile(COM.dragonflow.SiteView.Platform.getRoot() + java.io.File.separator + "templates.view" + java.io.File.separator + s2 + "Link.txt");
                                outputStream.println("\n" + stringbuffer1.toString() + "\n");
                            } else
                            if(atomicmonitor.getClassProperty("loadable").equals("true") && file.exists())
                            {
                                java.lang.StringBuffer stringbuffer2 = COM.dragonflow.Utils.FileUtils.readCharFile(COM.dragonflow.SiteView.Platform.getRoot() + java.io.File.separator + "templates.view" + java.io.File.separator + s2 + "Link.txt");
                        ...
                        catch(java.lang.Exception exception)
                        {
                            if(file.exists())
                            {
                                java.lang.StringBuffer stringbuffer3 = COM.dragonflow.Utils.FileUtils.readCharFile(COM.dragonflow.SiteView.Platform.getRoot() + java.io.File.separator + "templates.view" + java.io.File.separator + s2 + "Link.txt");
                                outputStream.println("\n" + stringbuffer3.toString() + "\n");
                            } else
                            {
                                java.lang.System.err.println(exception + " unable to find wizard link file. ");
                            }
                        }
                    }
    ...
    void writeFrameFile(jgl.Array array, java.lang.String s, java.lang.String s1)
    {
        try
        {
        ...
        {
            java.lang.System.err.println(exception + "An error occurred when trying to write the file: " + s);
        }
    }

    private java.lang.String updateMCSettings()
    {
        java.lang.String s = "license not updated";
        COM.dragonflow.SiteView.SiteViewGroup siteviewgroup = COM.dragonflow.SiteView.SiteViewGroup.currentSiteView();
        ...
        java.lang.String s1 = siteviewgroup.getSetting("_license");
        java.lang.String s2 = request.getValue("scopeLicense").trim();
        if(!s2.equals(s1) && COM.dragonflow.Utils.LUtils.isValidLicense(s2))
        {
            siteviewgroup.setProperty("_license", s2);
            s = "license updated";
        }
        java.lang.String s3 = siteviewgroup.getSetting("_licenseForX");
        java.lang.String s4 = request.getValue("scopeForXLicense").trim();
        if(!s3.equals(s4) && COM.dragonflow.Utils.LUtils.isValidLicense(s4))
        {
            siteviewgroup.setProperty("_licenseForX", s4);
        }
        java.lang.String s5 = siteviewgroup.getSetting("_autoEmail");
        if(s5 != null && s5.length() != 0)
        {
            java.lang.String s6 = siteviewgroup.getSetting("_nextConditionID");
            if(s6 == null || s6.equals(""))
            {
                s6 = "1";
            }
            java.lang.String s7 = "category eq 'error' and errorCount == 1\tmailto " + s5 + " Default" + "\t" + s6;
            siteviewgroup.setProperty("_alertCondition", s7);
            java.lang.String s8 = COM.dragonflow.Utils.TextUtils.increment(s6);
    ...
    void updateStatusPage(jgl.Array array)
    {
        ...
        try
        {
            ...
            {
                COM.dragonflow.SiteView.SiteViewGroup.updateStaticPages((java.lang.String)array.at(i));
            }
