...
public class SNMPSession
{
    ...
    public static final java.lang.String NoAuthentication = "NoAuthentication";
    public static final java.lang.String NOT_DISPLAYABLE = "NOT DISPLAYABLE";
    ...
    private java.lang.StringBuffer error;
    ...
    public SNMPSession(java.lang.String s, java.lang.String s1, java.lang.String s2, java.lang.String s3, java.lang.String s4, java.lang.String s5, java.lang.String s6)
    ...
    public SNMPSession(java.lang.String s, int i, java.lang.String s1)
        throws COM.dragonflow.Utils.Snmp.SNMPSessionException
    {
        engineID = null;
        contextEngineID = null;
    ...
    public COM.dragonflow.Utils.Snmp.SNMPVariableBinding[] get(COM.dragonflow.Utils.Snmp.SNMPVariableBinding asnmpvariablebinding[])
    {
        ...
        if(pdu1 != null)
        {
            ...
            for(int j = 0; j < avariablebinding.length; j++)
            {
                ...
                java.lang.String s = variable.toString();
    ...
    public COM.dragonflow.Utils.Snmp.SNMPVariableBinding[] get(java.lang.String as[], java.lang.String as1[])
    {
    ...
    protected com.netaphor.snmp.VariableBinding[] getColumn(java.lang.String s)
    {
        error.setLength(0);
    ...
    public COM.dragonflow.Utils.Snmp.SNMPVariableBinding[] getTableColumn(java.lang.String s)
    {
        error.setLength(0);
        com.netaphor.snmp.VariableBinding avariablebinding[] = null;
        try
    ...
    private java.lang.String validateOID(java.lang.String s, java.lang.String s1)
    {
        ...
        if(s1 != null)
        {
            java.lang.String s2 = COM.dragonflow.Utils.TextUtils.removeChars(s1, ".");
            if(s2.length() > 0)
            {
    ...
    public COM.dragonflow.Utils.Snmp.SNMPVariableBinding getNext(java.lang.String s)
    {
        error.setLength(0);
    ...
    protected java.lang.String formatOctetString(com.netaphor.snmp.VariableBinding variablebinding)
    {
    ...
    private java.lang.String filterNonPrintableCharacters(java.lang.String s, char c)
    {
        if(s == null)
        {
            return s;
    ...
    private java.lang.String formatDateAndTime(com.netaphor.snmp.OctetString octetstring)
    {
    ...
    private java.lang.String formatTAddress(com.netaphor.snmp.OctetString octetstring)
    {
        byte abyte0[] = octetstring.getValue();
        if(abyte0.length < 4)
        {
    ...
    public boolean isErrorString(java.lang.String s)
    {
        return errorStrings.get(s) != null;
    }

    private static byte[] getByteArrayFromHexString(java.lang.String s)
    {
