...
public class SiteViewXMLQuery
{
    ...
    public static java.lang.String TRUE_STRING = "true";
    public static java.lang.String XML_HEADER = "<?xml version=\"1.0\"?>";
    jgl.Array servers;
    ...
    static java.lang.String indentStrings[];
    ...
    public SiteViewXMLQuery(jgl.HashMap hashmap, COM.dragonflow.HTTP.HTTPRequest httprequest)
    {
        ...
        if(COM.dragonflow.Utils.TextUtils.getValue(hashmap, "remote").length() > 0)
        {
            ...
            java.lang.String s = COM.dragonflow.Utils.TextUtils.getValue(config, "_httpActivePort");
    ...
    public SiteViewXMLQuery(jgl.HashMap hashmap, java.lang.StringBuffer stringbuffer, COM.dragonflow.HTTP.HTTPRequest httprequest)
    {
        this(hashmap, httprequest);
        buffer = stringbuffer;
    }
    ...
    public jgl.Array getServers(jgl.HashMap hashmap)
    {
        ...
        {
            java.lang.String s = COM.dragonflow.SiteView.Platform.getRoot() + "/groups/" + "multi.config";
            try
            {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            java.lang.String s1 = COM.dragonflow.Utils.TextUtils.getValue(hashmap2, "server");
    ...
    {
        java.lang.String s1 = getIndentString();
    ...
    public jgl.HashMap setupQueryMap(jgl.HashMap hashmap, java.lang.String s)
    {
    ...
    boolean groupAllowed(java.lang.String s)
    {
    ...
    void printMonitor(COM.dragonflow.SiteView.Monitor monitor)
    {
        ...
        if(addLinks)
        {
            ...
            java.lang.String s = monitor.getTableMoreLink(request);
    ...
    {
        java.lang.String s = COM.dragonflow.Utils.TextUtils.getValue(hashmap, "server");
        java.lang.String s1 = "http://";
        if(s.indexOf("://") != -1)
        {
            s1 = "";
        }
        java.lang.String s2 = s1 + s + "/SiteView/cgi/go.exe/SiteView";
        java.lang.String s3 = COM.dragonflow.Utils.TextUtils.getValue(hashmap, "account");
        java.lang.String s4 = "";
        java.lang.String s5 = COM.dragonflow.Utils.TextUtils.getValue(hashmap, "proxy");
        java.lang.String s6 = COM.dragonflow.Utils.TextUtils.getValue(hashmap, "proxyusername");
        java.lang.String s7 = COM.dragonflow.Utils.TextUtils.getValue(hashmap, "proxypassword");
        java.lang.String s8 = COM.dragonflow.Utils.TextUtils.getValue(hashmap, "username");
        java.lang.String s9 = COM.dragonflow.Utils.TextUtils.getValue(hashmap, "password");
        java.lang.String s10 = COM.dragonflow.Utils.TextUtils.getValue(hashmap, "timeout");
        int i = 60000;
        if(s10.length() != 0)
        {
        ...
        if(al[0] == 200L)
        {
            java.lang.String s11 = COM.dragonflow.StandardMonitor.URLMonitor.getHTTPContent(stringbuffer.toString());
    ...
    void addMapToPostData(jgl.HashMap hashmap, java.lang.String s, jgl.Array array)
    {
        if(hashmap != null)
        {
            java.lang.String s1;
    ...
    void printXML(COM.dragonflow.SiteView.SiteViewObject siteviewobject)
    {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            {
                java.lang.String s = stringproperty.getName();
                s = s.replace('/', '-');
                java.lang.String s1 = "";
    ...
    {
        java.lang.String s = rule.getProperty(COM.dragonflow.SiteView.Rule.pAction);
    ...
    {
        INDENT_STRING = "  ";
        indentStrings = new java.lang.String[25];
        java.lang.String s = "";
        for(int i = 0; i < 25; i++)
        {
            indentStrings[i] = s;
