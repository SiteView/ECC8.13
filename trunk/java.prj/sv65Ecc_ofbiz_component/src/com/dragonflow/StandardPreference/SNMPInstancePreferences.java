...
public class SNMPInstancePreferences extends com.dragonflow.SiteView.Preferences {
    ...
    public java.util.Vector<String> test(String s) throws Exception {
    ...
    public Vector<String> getScalarValues(com.dragonflow.Properties.ScalarProperty scalarproperty, com.dragonflow.HTTP.HTTPRequest httprequest) throws com.dragonflow.SiteViewException.SiteViewException {
    ...
    static {
        ...
        StringProperty astringproperty[] = { pName, pDisabled, pSnmpHost, pSnmpObjectID, pSnmpObjectIDOther, pSnmpCommunity, pSnmpGeneric, pSnmpSpecific, pSnmpTrapVersion };
        addProperties("com.dragonflow.StandardPreference.SNMPInstancePreferences", astringproperty);
    }
}
