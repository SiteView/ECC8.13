...
public class AbsoluteScheduleInstancePreferences extends com.dragonflow.StandardPreference.ScheduleInstancePreferences {
    ...
    static {
        ...
        pAtSunday.setDisplayText(
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atSunday",PreferencesIniValueReader.LABEL), 
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atSunday",PreferencesIniValueReader.DESCRIPTION));
        pAtSunday.setParameterOptions(true, 1, false);
        pAtMonday = new StringProperty("atMonday");
        //pAtMonday.setDisplayText("at", "");
        pAtMonday.setDisplayText(
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atMonday",PreferencesIniValueReader.LABEL), 
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atMonday",PreferencesIniValueReader.DESCRIPTION));
        pAtMonday.setParameterOptions(true, 2, false);
        pAtTuesday = new StringProperty("atTuesday");
        //pAtTuesday.setDisplayText("at", "");
        pAtTuesday.setDisplayText(
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atTuesday",PreferencesIniValueReader.LABEL), 
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atTuesday",PreferencesIniValueReader.DESCRIPTION));
        pAtTuesday.setParameterOptions(true, 3, false);
        pAtWednesday = new StringProperty("atWednesday");
        //pAtWednesday.setDisplayText("at", "");
        pAtWednesday.setDisplayText(
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atWednesday",PreferencesIniValueReader.LABEL), 
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atWednesday",PreferencesIniValueReader.DESCRIPTION));
        pAtWednesday.setParameterOptions(true, 4, false);
        pAtThursday = new StringProperty("atThursday");
        //pAtThursday.setDisplayText("at", "");
        pAtThursday.setDisplayText(
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atThursday",PreferencesIniValueReader.LABEL), 
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atThursday",PreferencesIniValueReader.DESCRIPTION));
        pAtThursday.setParameterOptions(true, 5, false);
        pAtFriday = new StringProperty("atFriday");
        //pAtFriday.setDisplayText("at", "");
        pAtFriday.setDisplayText(
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atFriday",PreferencesIniValueReader.LABEL), 
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atFriday",PreferencesIniValueReader.DESCRIPTION));
        pAtFriday.setParameterOptions(true, 6, false);
        pAtSaturday = new StringProperty("atSaturday");
        //pAtSaturday.setDisplayText("at", "");
        pAtSaturday.setDisplayText(
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atSaturday",PreferencesIniValueReader.LABEL), 
        		PreferencesIniValueReader.getValue(AbsoluteScheduleInstancePreferences.class.getName(), "atSaturday",PreferencesIniValueReader.DESCRIPTION));
