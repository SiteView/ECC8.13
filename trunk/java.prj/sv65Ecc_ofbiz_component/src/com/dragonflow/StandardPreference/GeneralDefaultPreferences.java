...
public class GeneralDefaultPreferences extends com.dragonflow.SiteView.Preferences {
    ...
    public static jgl.Array getAuthOn401DropDown()
    {
    	jgl.Array retArray= new jgl.Array();
    	retArray.add(URLMonitor.authOn401DropDown[2]);
    	retArray.add(URLMonitor.authOn401DropDown[3]);
    	retArray.add(URLMonitor.authOn401DropDown[4]);
    	retArray.add(URLMonitor.authOn401DropDown[5]);
    	return retArray;
    }
