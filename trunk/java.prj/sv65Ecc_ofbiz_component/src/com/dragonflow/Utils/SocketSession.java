...
public class SocketSession
{
    ...
    public String getEncodePostData()
    {
        ...
        {
            return URLMonitor.urlencodedDropDown[0];
        } else
        {
    ...
    public String getAuthenticationWhenRequested()
    {
        ...
        {
            return URLMonitor.authOn401DropDown[0];
        } else
        {
    ...
    private static jgl.Array addCookie(jgl.Array array, jgl.HashMap hashmap)
    {
        ...
        if(flag1 && (URLMonitor.debugURL & URLMonitor.kDebugCookie) != 0)
        {
        ...
        do
        {
            ...
            if(com.dragonflow.Utils.TextUtils.getValue(hashmap1, "key").equalsIgnoreCase(s) && com.dragonflow.Utils.TextUtils.getValue(hashmap1, "domain").equalsIgnoreCase(com.dragonflow.Utils.TextUtils.getValue(hashmap, "domain")) && com.dragonflow.Utils.TextUtils.getValue(hashmap1, "path").equalsIgnoreCase(com.dragonflow.Utils.TextUtils.getValue(hashmap, "path")))
            {
                ...
                {
                    array.remove(i);
                    if((URLMonitor.debugURL & URLMonitor.kDebugCookie) != 0)
                    {
    ...
    {
        if(com.dragonflow.Utils.TextUtils.startsWithIgnoreCase(s, URLMonitor.SET_COOKIE_HEADER))
        {
            if((URLMonitor.debugURL & URLMonitor.kDebugCookie) != 0)
            {
            ...
            String as[] = com.dragonflow.Utils.TextUtils.split(s.substring(URLMonitor.SET_COOKIE_HEADER.length()).trim(), ";");
    ...
    {
        String s2 = URLMonitor.getHTTPHeaders(s);
        int i = 0;
        int j;
        do
        {
