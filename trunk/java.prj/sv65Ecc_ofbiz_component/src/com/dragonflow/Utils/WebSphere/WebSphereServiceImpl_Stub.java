...
public final class WebSphereServiceImpl_Stub extends java.rmi.server.RemoteStub implements com.dragonflow.Utils.WebSphere.WebSphereService, java.rmi.Remote {
    ...
    private static Method $method_getServer_0;

    private static Method $method_getToken_1;
    ...
    public com.dragonflow.Utils.WebSphere.WebSphereServer getServer(com.dragonflow.Utils.WebSphere.WebSphereConnectionProperties websphereconnectionproperties) throws java.rmi.RemoteException {
        try {
            if (useNewInvoke) {
                Object obj = super.ref.invoke(this, $method_getServer_0, new Object[] { websphereconnectionproperties }, 0x957f931896ad1f02L);
    ...
    public long getToken() throws java.rmi.RemoteException {
        try {
            if (useNewInvoke) {
                Object obj = super.ref.invoke(this, $method_getToken_1, null, 0xdb8bfedf0878e4a5L);
    ...
    static {
        try {
            (java.rmi.server.RemoteRef.class).getMethod("invoke", new Class[] { java.rmi.Remote.class, Method.class, Object[].class, Long.TYPE });
            useNewInvoke = true;
            $method_getServer_0 = (com.dragonflow.Utils.WebSphere.WebSphereService.class).getMethod("getServer", new Class[] { com.dragonflow.Utils.WebSphere.WebSphereConnectionProperties.class });
            $method_getToken_1 = (com.dragonflow.Utils.WebSphere.WebSphereService.class).getMethod("getToken", new Class[0]);
