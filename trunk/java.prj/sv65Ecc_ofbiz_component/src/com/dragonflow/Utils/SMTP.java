...
public class SMTP
{
    ...
    static String RFCDateFormat(java.util.Date date)
    {
        ...
        return as[date.getDay()] + ", " + String.valueOf(date.getDate()) + " " + as1[date.getMonth()] + " " + s1 + " " + com.dragonflow.Utils.SMTP.twoDigits(date.getHours()) + ":" + com.dragonflow.Utils.SMTP.twoDigits(date.getMinutes()) + ":" + com.dragonflow.Utils.SMTP.twoDigits(date.getSeconds()) + " " + s + com.dragonflow.Utils.SMTP.twoDigits(Math.abs(date.getTimezoneOffset()) / 60) + com.dragonflow.Utils.SMTP.twoDigits(Math.abs(date.getTimezoneOffset()) % 60);
    }
        ...
        throws Exception
    {
        ...
        for(java.util.Enumeration enumeration = array.elements(); enumeration.hasMoreElements(); System.out.println(enumeration.nextElement())) { }
    }
