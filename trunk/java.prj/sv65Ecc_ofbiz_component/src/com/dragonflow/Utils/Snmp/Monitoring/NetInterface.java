...
public class NetInterface
{
    ...
    public String getMetricByName(String s)
    {
        if(s.startsWith("totalIfInOctets"))
        {
            return Long.toString(inOctets);
        }
        if(s.startsWith("totalIfOutOctets"))
        {
            return Long.toString(outOctets);
        }
        ...
        if(s.startsWith("totalIfInUcastPkts"))
        {
            return Long.toString(inUnicastPackets);
        }
        if(s.startsWith("totalIfOutUcastPkts"))
        {
            return Long.toString(outUnicastPackets);
        }
        if(s.startsWith("totalIfInDiscards"))
        {
            return Long.toString(inDiscards);
        }
        if(s.startsWith("totalIfOutDiscards"))
        {
            return Long.toString(outDiscards);
        }
        if(s.startsWith("totalIfInErrors"))
        {
            return Long.toString(inErrors);
        }
        if(s.startsWith("totalIfOutErrors"))
        {
            return Long.toString(outErrors);
        }
        if(s.startsWith("measureTime"))
        {
        ...
        {
            return Long.toString(getBytesIn());
        }
        if(s.startsWith("ifOutOctets"))
        {
            return Long.toString(getBytesOut());
        }
        if(s.startsWith("ifInDiscards"))
        {
            return Long.toString(getDiscardsIn());
        }
        if(s.startsWith("ifOutDiscards"))
        {
            return Long.toString(getDiscardsOut());
        }
        if(s.startsWith("ifInErrors"))
        {
            return Long.toString(getErrorsIn());
        }
        if(s.startsWith("ifOutErrors"))
        {
            return Long.toString(getErrorsOut());
        }
        if(s.startsWith("ifInUcastPkts"))
        {
            return Long.toString(getUnicastPacketsIn());
        }
        if(s.startsWith("ifOutUcastPkts"))
        {
            return Long.toString(getUnicastPacketsOut());
        }
        if(s.startsWith("ifOutQLen"))
        {
            return Long.toString(getOutQLen());
        }
        if(s.startsWith("percentBWUsed"))
        {
            return Integer.toString((int)getPercentTotalBandwidthUtil());
        } else
        {
            return "";
        }
