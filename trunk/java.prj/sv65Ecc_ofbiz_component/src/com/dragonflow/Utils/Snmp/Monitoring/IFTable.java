...
public class IFTable
{
    ...
    private void updatePhysAddrToRowMap()
    {
        ...
        {
            Integer integer = new Integer(physAddresses[i].getLastSubID());
            String s;
    ...
    private void updateDescriptionToRowMap()
    {
        ...
        for(int i = 0; i < ifDescriptions.length; i++)
        {
            ...
            Integer integer = new Integer(ifDescriptions[i].getLastSubID());
    ...
    private void updateNameToRowMap()
    {
        ...
        for(int i = 0; i < ifNames.length; i++)
        {
            ...
            Integer integer = new Integer(ifNames[i].getLastSubID());
    ...
    private int lookupRowFromText(java.util.Map map, String s)
    {
        if(s != null)
        {
            Integer integer = (Integer)map.get(s.trim());
            if(integer != null)
            {
