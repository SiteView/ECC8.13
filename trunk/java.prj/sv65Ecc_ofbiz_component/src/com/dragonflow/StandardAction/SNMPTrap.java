...
public class SNMPTrap extends com.dragonflow.SiteView.Action
{
    ...
    public void initializeFromArguments(jgl.Array array, jgl.HashMap hashmap)
    {
        ...
        for(java.util.Enumeration enumeration = hashmap.values("_id"); enumeration.hasMoreElements(); addProperty(pSNMPSetting, (String)enumeration.nextElement())) { }
    ...
    public String getActionString()
    {
        ...
        {
            for(java.util.Enumeration enumeration = getMultipleValues(pSNMPSetting); enumeration.hasMoreElements(); stringbuffer.append((String)enumeration.nextElement()))
            {
