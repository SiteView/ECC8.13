...
public class HTTPRequestThread implements Runnable {
    ...
    void handleGetURL(com.dragonflow.HTTP.HTTPRequest httprequest) throws Exception {
    ...
    void handlePortURL(com.dragonflow.HTTP.HTTPRequest httprequest) throws Exception {
        httprequest.setContentType("text/plain");
        httprequest.printHeader(outputStream);
...
//        outputStream.println("error=" + stringbuffer + com.dragonflow.StandardMonitor.URLMonitor.CRLF);
    ...
    void handlePingURL(com.dragonflow.HTTP.HTTPRequest httprequest) throws Exception {
        httprequest.setContentType("text/plain");
        httprequest.printHeader(outputStream);
        String s = httprequest.getValue("host");
        ...
        boolean flag = false;
        try {
            Process process = com.dragonflow.Utils.CommandLine.execSync(s1);
            boolean flag1 = false;
    ...
    void handleTraceURL(com.dragonflow.HTTP.HTTPRequest httprequest) throws Exception {
        httprequest.setContentType("text/plain");
        httprequest.printHeader(outputStream);
        String s = httprequest.getValue("host");
                ...
                if (!flag) {
                    if (httprequest.isScript()) {
                        ...
                        try {
                            ...
                            if (s9 != null) {
                                class1 = Class.forName(((String) (s9)));
