...
public class ProxyHandler {
    ...
    public static void handleProxyRequest(com.dragonflow.HTTP.HTTPRequest httprequest, java.io.PrintWriter printwriter) {
        ...
        if (array != null) {
            for (java.util.Enumeration enumeration1 = array.elements(); enumeration1.hasMoreElements(); com.dragonflow.Utils.TextUtils.debugPrint((String) enumeration1.nextElement())) {
            }
        }
