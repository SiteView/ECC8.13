...
public class HTTPRequest
{
    ...
    public static void printErrorMessage(com.dragonflow.HTTP.HTTPRequest httprequest, int i, String s, Exception exception, java.io.PrintWriter printwriter)
    {
            ...
            do
            {
                ...
                if(j >= 0)
                {
                    ...
                    if(s7.equalsIgnoreCase("Content-length"))
                    {
                        try
                        {
                            requestContentLength = Integer.parseInt(s8);
                        }
        ...
        throws com.dragonflow.HTTP.HTTPRequestException
    {
        ...
        try
        {
            ...
            if(System.getProperty("CONTENT_LENGTH") != null)
            {
                try
                {
                    requestContentLength = Integer.parseInt(System.getProperty("CONTENT_LENGTH"));
                }
                catch(NumberFormatException numberformatexception) { }
            }
    ...
    public static String encodeString(String s, String s1)
    {
        ...
        for(int l = 0; abyte0 != null && l < abyte0.length; l++)
        {
            ...
            if(i1 > 127)
            {
                stringbuffer.append("%" + Integer.toHexString(i1 >> 4) + Integer.toHexString(i1 & 0xf));
                continue;
            }
    ...
    public void setValues(String s, java.util.Enumeration enumeration)
    {
        if(variables == null)
        {
            variables = new HashMapOrdered(true);
    ...
    public java.util.Enumeration getValues(String s)
    {
        if(variables != null)
        {
...
//        } else
    ...
    public static void dumpMatch(String s, String s1, String s2)
    {
        ...
        if(i >= 0)
        {
            ...
            {
                System.out.print(Integer.toHexString(s4.charAt(j)) + ", ");
            }
