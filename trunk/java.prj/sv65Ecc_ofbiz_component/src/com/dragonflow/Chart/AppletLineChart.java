...
public class AppletLineChart {
    ...
    public void drawChart() {
        ...
        errorBarHeight = Math.max(drawer.stringHeight() * 2, errorBarHeight);
    ...
    void drawHorizontalUnits() {
        ...
        byte byte2 = 5;
        byte byte3 = 20;
        int j2 = Math.min(k1, 170);
        int k2 = imageWidth - (j2 + 5);
        int l2 = Math.min(j1, 95);
        int i3 = k2 - (l2 + 10);
    ...
    void drawData(com.dragonflow.Chart.AppletDataSet appletdataset, boolean flag, boolean flag1) {
        ...
        do {
            ...
            int i1 = Math.round((float) (appletdataset.sampleTime - startTime) * timeScale);
            if (l >= 0) {
            ...
            if (appletdataset.sampleHasValue) {
                ...
                int j1 = Math.round(f * appletdataset.scale);
    ...
    public static int readIntegerSafe(String s, int i) throws NumberFormatException {
