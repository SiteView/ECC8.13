...
public abstract class Chart {
    ...
    void drawAverage() {
        if (dataSet.length == 1) {
            ...
            int i = Math.round(f * dataSet[0].scale);
            if (i > 0) {
    ...
    void drawHorizontalUnits() {
        ...
        if (dataSet.length != 1) {
            ...
            byte byte0 = 5;
            byte byte1 = 20;
            int i4 = Math.min(j3, 170);
            int j4 = imageWidth - (i4 + 5);
            int k4 = Math.min(k2, 95);
            int l4 = j4 - (k4 + 10);
    ...
    void drawData(com.dragonflow.Chart.DataSet dataset, boolean flag, boolean flag1) {
        ...
        do {
            ...
            int i1 = Math.round((float) (dataset.sampleTime - startTime) * timeScale);
            if (l >= 0) {
            ...
            if (dataset.sampleHasValue) {
                ...
                int j1 = Math.round(f * dataset.scale);
