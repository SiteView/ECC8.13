...
public class CPUMonitor extends ServerMonitor
{
 ...
 static 
 {
     ...
     pUtilization = new PercentProperty("_Utilization");
     pUtilization.setDisplayText(MonitorIniValueReader.getValue(CPUMonitor.class.getName(),"_Utilization",MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(CPUMonitor.class.getName(), "_Utilization",MonitorIniValueReader.DESCRIPTION));
     ...
     setClassProperty("com.dragonflow.StandardMonitor.CPUMonitor", "description", MonitorTypeValueReader.getValue(CPUMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
     ...
     setClassProperty("com.dragonflow.StandardMonitor.CPUMonitor", "title", MonitorTypeValueReader.getValue(CPUMonitor.class.getName(), MonitorTypeValueReader.TITLE));
     ...
     setClassProperty("com.dragonflow.StandardMonitor.CPUMonitor", "target", MonitorTypeValueReader.getValue(CPUMonitor.class.getName(), MonitorTypeValueReader.TARGET));
     //setClassProperty("com.dragonflow.StandardMonitor.CPUMonitor", "target", "_cpu");
     
     setClassProperty("com.dragonflow.StandardMonitor.CPUMonitor", "topazName", MonitorTypeValueReader.getValue(CPUMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
     //setClassProperty("com.dragonflow.StandardMonitor.CPUMonitor", "topazName", "CPU");
     
     setClassProperty("com.dragonflow.StandardMonitor.CPUMonitor", "topazType", MonitorTypeValueReader.getValue(CPUMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
     //setClassProperty("com.dragonflow.StandardMonitor.CPUMonitor", "topazType", "System Resources");
     
     setClassProperty("com.dragonflow.StandardMonitor.CPUMonitor", "classType", MonitorTypeValueReader.getValue(CPUMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
