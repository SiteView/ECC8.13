...
//    }
    ...
    static {
        ...
        pHostName.setDisplayText(MonitorIniValueReader.getValue(IPMIMonitor.class.getName(), "_server", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(IPMIMonitor.class.getName(), "_server", MonitorIniValueReader.DESCRIPTION));
        ...
        pPortNumber.setDisplayText(MonitorIniValueReader.getValue(IPMIMonitor.class.getName(), "_port", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(IPMIMonitor.class.getName(), "_port", MonitorIniValueReader.DESCRIPTION));
        ...
        pUserName.setDisplayText(MonitorIniValueReader.getValue(IPMIMonitor.class.getName(), "_user", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(IPMIMonitor.class.getName(), "_user", MonitorIniValueReader.DESCRIPTION));
        ...
        pPassword.setDisplayText(MonitorIniValueReader.getValue(IPMIMonitor.class.getName(), "_password", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(IPMIMonitor.class.getName(), "_password", MonitorIniValueReader.DESCRIPTION));
        ...
        setClassProperty(s, "description", MonitorTypeValueReader.getValue(IPMIMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        //setClassProperty(s, "description", "Collect IPMI data");
        
        setClassProperty(s, "help", "IPMIMonitor.htm");
        
        setClassProperty(s, "title", MonitorTypeValueReader.getValue(IPMIMonitor.class.getName(), MonitorTypeValueReader.TITLE));
        //setClassProperty(s, "title", "IPMI");
        
        setClassProperty(s, "class", "IPMIMonitor");
        
        setClassProperty(s, "topazType", MonitorTypeValueReader.getValue(IPMIMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
        //setClassProperty(s, "topazType", "IPMI");
        
        setClassProperty(s, "classType", MonitorTypeValueReader.getValue(IPMIMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
        ...
        setClassProperty(s, "target", MonitorTypeValueReader.getValue(IPMIMonitor.class.getName(), MonitorTypeValueReader.TARGET));
