...
public class BrowsableSNMPMonitor extends BrowsableSNMPBase
{
 ...
 static 
 {
     ...
     setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor", "description", MonitorTypeValueReader.getValue(BrowsableSNMPMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
     ...
     setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor", "title", MonitorTypeValueReader.getValue(BrowsableSNMPMonitor.class.getName(), MonitorTypeValueReader.TITLE));
     ...
     setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor", "target", MonitorTypeValueReader.getValue(BrowsableSNMPMonitor.class.getName(), MonitorTypeValueReader.TARGET));
     //setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor", "target", "_server");
     
     setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor", "topazName", MonitorTypeValueReader.getValue(BrowsableSNMPMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
     //setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor", "topazName", "SNMP by MIB Monitor");
     
     setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor", "toolName", MonitorTypeValueReader.getValue(BrowsableSNMPMonitor.class.getName(), MonitorTypeValueReader.TOOLNAME));
     //setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor", "toolName", "SNMP by MIB");
     
     setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor", "toolDescription", MonitorTypeValueReader.getValue(BrowsableSNMPMonitor.class.getName(), MonitorTypeValueReader.TOOLDESCRIPTION));
     //setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor", "toolDescription", "Browses an SNMP MIB.");
     
     setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor", "topazType", MonitorTypeValueReader.getValue(BrowsableSNMPMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
     //setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor", "topazType", "System Resources");
     
     setClassProperty("com.dragonflow.StandardMonitor.BrowsableSNMPMonitor","classType", MonitorTypeValueReader.getValue(BrowsableSNMPMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
