...
public class DirectoryMonitor extends AtomicMonitor
{
 ...
 static 
 {
     ...
     pPath.fieldLabels(MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "_path", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "_path", MonitorIniValueReader.DESCRIPTION));
     ...
     pNoSubdirectories.setDisplayText(MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "_noRecurse", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "_noRecurse", MonitorIniValueReader.DESCRIPTION));
     ...
     pMatch.setDisplayText(MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "_match", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "_match", MonitorIniValueReader.DESCRIPTION));
     ...
     pSize = new NumericProperty("size", "0", MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "size", MonitorIniValueReader.UNIT));
     //pSize = new NumericProperty("size", "0", "bytes");
     pSize.setLabel(MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "size", MonitorIniValueReader.LABEL));
     //pSize.setLabel("total of file sizes");
     pSize.setStateOptions(1);
     
     pPermitted = new StringProperty("permitted", "denied");
     pPermitted.setLabel(MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "permitted", MonitorIniValueReader.LABEL));
     ...
     pFileCount.setLabel(MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "fileCount", MonitorIniValueReader.LABEL));
     pFileCount.setLabel("number of files");
     pFileCount.setStateOptions(3);
     
     pExists = new StringProperty("exists", "missing");
     pExists.setLabel(MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "exists", MonitorIniValueReader.LABEL));
     pExists.setLabel("directory exists");
     pExists.setStateOptions(4);
     
     pAge = new NumericProperty("age", "0", MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "age", MonitorIniValueReader.UNIT));
     //pAge = new NumericProperty("age", "0", "minutes");
     pAge.setLabel(MonitorIniValueReader.getValue(DirectoryMonitor.class.getName(), "age", MonitorIniValueReader.LABEL));
     ...
     setClassProperty("com.dragonflow.StandardMonitor.DirectoryMonitor", "description", MonitorTypeValueReader.getValue(DirectoryMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
     ...
     setClassProperty("com.dragonflow.StandardMonitor.DirectoryMonitor", "title", MonitorTypeValueReader.getValue(DirectoryMonitor.class.getName(), MonitorTypeValueReader.TITLE));
     ...
     setClassProperty("com.dragonflow.StandardMonitor.DirectoryMonitor", "classType", MonitorTypeValueReader.getValue(DirectoryMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
     //setClassProperty("com.dragonflow.StandardMonitor.DirectoryMonitor", "classType", "advanced");
     
     setClassProperty("com.dragonflow.StandardMonitor.DirectoryMonitor", "topazName", MonitorTypeValueReader.getValue(DirectoryMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
     //setClassProperty("com.dragonflow.StandardMonitor.DirectoryMonitor", "topazName", "Windows Resources");
     
     setClassProperty("com.dragonflow.StandardMonitor.DirectoryMonitor", "topazType", MonitorTypeValueReader.getValue(DirectoryMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
     //setClassProperty("com.dragonflow.StandardMonitor.DirectoryMonitor", "topazType", "System Resources");
     
     setClassProperty("com.dragonflow.StandardMonitor.DirectoryMonitor", "target", MonitorTypeValueReader.getValue(DirectoryMonitor.class.getName(), MonitorTypeValueReader.TARGET));
