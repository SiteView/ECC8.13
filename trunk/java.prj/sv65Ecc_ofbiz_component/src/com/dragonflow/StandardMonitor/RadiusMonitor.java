...
public class RadiusMonitor extends AtomicMonitor
{
    ...
    static 
    {
        ...
        String server_description = MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_server", MonitorIniValueReader.DESCRIPTION);
        server_description = server_description.replaceAll("1%", Platform.exampleDomain);
        pServer.setDisplayText(MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_server", MonitorIniValueReader.LABEL), server_description);
        ...
        pSecret.setDisplayText(MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_serverPassword", MonitorIniValueReader.LABEL),  MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_serverPassword", MonitorIniValueReader.DESCRIPTION));
        ...
        pUserName.setDisplayText(MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_username", MonitorIniValueReader.LABEL),  MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_username", MonitorIniValueReader.DESCRIPTION));
        ...
        pPassword.setDisplayText(MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_password", MonitorIniValueReader.LABEL),  MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_password", MonitorIniValueReader.DESCRIPTION));
        ...
        pTimeout = new NumericProperty("_timeout", "30", MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_timeout", MonitorIniValueReader.UNIT));
        //pTimeout = new NumericProperty("_timeout", "30", "seconds");
        pTimeout.setDisplayText(MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_timeout", MonitorIniValueReader.LABEL),  MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_timeout", MonitorIniValueReader.DESCRIPTION));
        ...
        pPort.setDisplayText(MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_port", MonitorIniValueReader.LABEL),  MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_port", MonitorIniValueReader.DESCRIPTION));
        ...
        pContentMatch.setDisplayText(MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_content", MonitorIniValueReader.LABEL),  MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "_content", MonitorIniValueReader.DESCRIPTION));
        ...
        pMatchValue.setLabel(MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "matchValue", MonitorIniValueReader.LABEL));
        //pMatchValue.setLabel("match value");
        pMatchValue.setIsThreshold(true);
        
        pRoundTripTime = new NumericProperty("roundTripTime", "0", MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "roundTripTime", MonitorIniValueReader.UNIT));
        //pRoundTripTime = new NumericProperty("roundTripTime", "0", "milliseconds");
        pRoundTripTime.setLabel(MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "roundTripTime", MonitorIniValueReader.LABEL));
        //pRoundTripTime.setLabel("round trip time");
        pRoundTripTime.setStateOptions(1);
        
        pStatus = new StringProperty("status");
        pStatus.setLabel(MonitorIniValueReader.getValue(RadiusMonitor.class.getName(), "status", MonitorIniValueReader.LABEL));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.RadiusMonitor", "description", MonitorTypeValueReader.getValue(RadiusMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.RadiusMonitor", "title", MonitorTypeValueReader.getValue(RadiusMonitor.class.getName(), MonitorTypeValueReader.TITLE));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.RadiusMonitor", "classType", MonitorTypeValueReader.getValue(RadiusMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
        //setClassProperty("com.dragonflow.StandardMonitor.RadiusMonitor", "classType", "advanced");
        
        setClassProperty("com.dragonflow.StandardMonitor.RadiusMonitor", "target", MonitorTypeValueReader.getValue(RadiusMonitor.class.getName(), MonitorTypeValueReader.TARGET));
        //setClassProperty("com.dragonflow.StandardMonitor.RadiusMonitor", "target", "_server");
        
        setClassProperty("com.dragonflow.StandardMonitor.RadiusMonitor", "topazName", MonitorTypeValueReader.getValue(RadiusMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
        //setClassProperty("com.dragonflow.StandardMonitor.RadiusMonitor", "topazName", "Radius");
        
        setClassProperty("com.dragonflow.StandardMonitor.RadiusMonitor", "topazType", MonitorTypeValueReader.getValue(RadiusMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
