...
public class NetworkBandwidthMonitor extends BrowsableSNMPBase implements RealTimeReportingMonitor {
    ...
    static {
        ...
        pDeviceType.setDisplayText(MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_deviceType", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_deviceType", MonitorIniValueReader.DESCRIPTION));
        ...
        pDuplexState.setDisplayText(MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_duplexState", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_duplexState", MonitorIniValueReader.DESCRIPTION));
        ...
        pIndexingMethod.setDisplayText(MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_indexingMethod", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_indexingMethod", MonitorIniValueReader.DESCRIPTION));
        //pIndexingMethod.setDisplayText( "Interface Index", "specify how SiteView should keep track of the interfaces it is monitoring.  Some network devices do not persist the index used to identify a particular interface between reboots.  The interface description or physical address will usually remain the same, however.");
        ...
        pShowRTTraffic.setDisplayText(MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_showRTTraffic", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_showRTTraffic", MonitorIniValueReader.DESCRIPTION));
        ...
        pMaxRTDataWindow = new NumericProperty("_maxRTDataWindow", "24", MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_maxRTDataWindow", MonitorIniValueReader.UNIT));
        //pMaxRTDataWindow = new NumericProperty("_maxRTDataWindow", "24", "hours");
        pMaxRTDataWindow.setParameterOptions(true, i ++, true);
        pMaxRTDataWindow.setDisplayText(MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_maxRTDataWindow", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_maxRTDataWindow", MonitorIniValueReader.DESCRIPTION));
        ...
        pMaxRTDataVerticalAxis.setDisplayText(MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_maxRTDataVerticalAxis", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(NetworkBandwidthMonitor.class.getName(), "_maxRTDataVerticalAxis", MonitorIniValueReader.DESCRIPTION));
        ...
        setClassProperty(className, "description", MonitorTypeValueReader.getValue(NetworkBandwidthMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        ...
        setClassProperty(className, "title", MonitorTypeValueReader.getValue(NetworkBandwidthMonitor.class.getName(), MonitorTypeValueReader.TITLE));
        //setClassProperty(className, "title", "Network Bandwidth");
        
        setClassProperty(className, "class", "NetworkBandwidthMonitor");
        
        setClassProperty(className, "target", MonitorTypeValueReader.getValue(NetworkBandwidthMonitor.class.getName(), MonitorTypeValueReader.TARGET));
        //setClassProperty(className, "target", "_server");
        
        setClassProperty(className, "topazName", MonitorTypeValueReader.getValue(NetworkBandwidthMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
        //setClassProperty(className, "topazName", "Network Bandwidth Monitor");
        
        setClassProperty(className, "topazType", MonitorTypeValueReader.getValue(NetworkBandwidthMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
        //setClassProperty(className, "topazType", "System Resources");
        
        setClassProperty(className, "classType", MonitorTypeValueReader.getValue(NetworkBandwidthMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
