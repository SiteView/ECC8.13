...
public class ADReplicationMonitor extends AtomicMonitor {
    ...
    static {
        ...
        pStatus.setLabel(MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_Status", MonitorIniValueReader.LABEL));
        ...
        pDomainControllerName.setDisplayText(MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(),"_DomainControllerName",MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_DomainControllerName", MonitorIniValueReader.DESCRIPTION));
        ...
        pReplicatingDomainControllers.setDisplayText(MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_ReplicatingDomainControllers",MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_ReplicatingDomainControllers",MonitorIniValueReader.DESCRIPTION));
        ...
        pSecurityPrincipal.setDisplayText(MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_securityprincipal", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_securityprincipal",MonitorIniValueReader.DESCRIPTION));
        ...
        pSecurityCredential.setDisplayText(MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_password", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_password", MonitorIniValueReader.DESCRIPTION));
        ...
        pPoliingInterval.setDisplayText(MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_PoliingInterval", MonitorIniValueReader.LABEL), "Interval to poll, in seconds, for verification of replication.");
        ...
        pMaxRepTime.setDisplayText(MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_MaxRepTime", MonitorIniValueReader.LABEL), "The maximum amount of time, in seconds, to poll for verification of replication.");
        ...
        pDirectoryRootPath.setDisplayText(MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_DirectoryRootPath", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_DirectoryRootPath", MonitorIniValueReader.DESCRIPTION));
        ...
        pLatencyObjectContainerPath.setDisplayText(MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_containerPath", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_containerPath", MonitorIniValueReader.DESCRIPTION));
        ...
        String labelstring = MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_replicationTime", MonitorIniValueReader.LABEL);
        
        for (int l = 0; l < maxNumberOfReplicatingDC; l ++) {
        	replicationTime[l] = new NumericProperty(REPLICATION_TIME+1,"",MonitorIniValueReader.getValue(ADReplicationMonitor.class.getName(), "_replicationTime", MonitorIniValueReader.UNIT));
            //replicationTime[l] = new NumericProperty(REPLICATION_TIME + l, "", "seconds");
        	labelstring=labelstring.replaceAll("1%", ""+1+1);
            replicationTime[l].setLabel(labelstring);
        ...
        setClassProperty(s,"description",MonitorTypeValueReader.getValue(ADReplicationMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        ...
        setClassProperty(s, "title",MonitorTypeValueReader.getValue(ADReplicationMonitor.class.getName(), MonitorTypeValueReader.TITLE));
        //setClassProperty(s, "title", "Active Directory Replication Monitor");
        
        
        setClassProperty(s, "class", "ADReplicationMonitor");
        
        setClassProperty(s, "classType",MonitorTypeValueReader.getValue(ADReplicationMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
        //setClassProperty(s, "classType", "application");
        
        setClassProperty(s, "toolName",MonitorTypeValueReader.getValue(ADReplicationMonitor.class.getName(), MonitorTypeValueReader.TOOLNAME));
        //setClassProperty(s, "toolName", "LDAP Authentication");
        
        setClassProperty(s, "toolDescription",MonitorTypeValueReader.getValue(ADReplicationMonitor.class.getName(), MonitorTypeValueReader.TOOLDESCRIPTION));
        //setClassProperty(s, "toolDescription", "Test an LDAP server by authenticating a user.");
        
        setClassProperty(s, "topazName",MonitorTypeValueReader.getValue(ADReplicationMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
        //setClassProperty(s, "topazName", "Active Directory Replication Monitor");
        
        setClassProperty(s, "topazType",MonitorTypeValueReader.getValue(ADReplicationMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
