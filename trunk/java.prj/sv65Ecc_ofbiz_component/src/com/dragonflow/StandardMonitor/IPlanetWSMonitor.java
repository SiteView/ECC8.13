...
public class IPlanetWSMonitor extends BrowsableSNMPBase
{
    ...
    static 
    {
        ...
        setClassProperty("com.dragonflow.StandardMonitor.IPlanetWSMonitor", "description", MonitorTypeValueReader.getValue(IPlanetWSMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.IPlanetWSMonitor", "title", MonitorTypeValueReader.getValue(IPlanetWSMonitor.class.getName(), MonitorTypeValueReader.TITLE));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.IPlanetWSMonitor", "target", MonitorTypeValueReader.getValue(IPlanetWSMonitor.class.getName(), MonitorTypeValueReader.TARGET));
        //setClassProperty("com.dragonflow.StandardMonitor.IPlanetWSMonitor", "target", "_server");
        
        setClassProperty("com.dragonflow.StandardMonitor.IPlanetWSMonitor", "topazName", MonitorTypeValueReader.getValue(IPlanetWSMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
        //setClassProperty("com.dragonflow.StandardMonitor.IPlanetWSMonitor", "topazName", "IPlanet Web Server");
        
        setClassProperty("com.dragonflow.StandardMonitor.IPlanetWSMonitor", "classType", MonitorTypeValueReader.getValue(IPlanetWSMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
        //setClassProperty("com.dragonflow.StandardMonitor.IPlanetWSMonitor", "classType", "application");
        
        setClassProperty("com.dragonflow.StandardMonitor.IPlanetWSMonitor", "topazType", MonitorTypeValueReader.getValue(IPlanetWSMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
