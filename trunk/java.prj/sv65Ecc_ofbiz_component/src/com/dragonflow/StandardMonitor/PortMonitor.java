...
public class PortMonitor extends AtomicMonitor {
    ...
    static {
        ...
        String hostname_description = MonitorIniValueReader.getValue(PortMonitor.class.getName(), "_hostname", MonitorIniValueReader.DESCRIPTION);
        hostname_description = hostname_description.replaceAll("1%", Platform.exampleDomain);
        pHost.setDisplayText(MonitorIniValueReader.getValue(PortMonitor.class.getName(), "_hostname", MonitorIniValueReader.LABEL), hostname_description);
        ...
        pPort.setDisplayText(MonitorIniValueReader.getValue(PortMonitor.class.getName(), "_port", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(PortMonitor.class.getName(), "_port", MonitorIniValueReader.DESCRIPTION));
        ...
        pSendString.setDisplayText(MonitorIniValueReader.getValue(PortMonitor.class.getName(), "_sendString", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(PortMonitor.class.getName(), "_sendString", MonitorIniValueReader.DESCRIPTION));
        ...
        pMatchString.setDisplayText(MonitorIniValueReader.getValue(PortMonitor.class.getName(), "_matchString", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(PortMonitor.class.getName(), "_matchString", MonitorIniValueReader.DESCRIPTION));
        ...
        pTimeout = new NumericProperty("_timeout", "60", MonitorIniValueReader.getValue(PortMonitor.class.getName(), "_timeout", MonitorIniValueReader.UNIT));
        //pTimeout = new NumericProperty("_timeout", "60", "seconds");
        pTimeout.setDisplayText(MonitorIniValueReader.getValue(PortMonitor.class.getName(), "_timeout", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(PortMonitor.class.getName(), "_timeout", MonitorIniValueReader.DESCRIPTION));
        ...
        pRoundTripTime = new NumericProperty("roundTripTime", "0", MonitorIniValueReader.getValue(PortMonitor.class.getName(), "roundTripTime", MonitorIniValueReader.UNIT));
        //pRoundTripTime = new NumericProperty("roundTripTime", "0", "milliseconds");
        pRoundTripTime.setLabel(MonitorIniValueReader.getValue(PortMonitor.class.getName(), "roundTripTime", MonitorIniValueReader.LABEL));
        //pRoundTripTime.setLabel("round trip time");
        pRoundTripTime.setStateOptions(1);
        
        pStatus = new StringProperty("status", "no data");
        pStatus.setLabel(MonitorIniValueReader.getValue(PortMonitor.class.getName(), "status", MonitorIniValueReader.LABEL));
        ...
        pValue.setLabel(MonitorIniValueReader.getValue(PortMonitor.class.getName(), "value", MonitorIniValueReader.LABEL));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.PortMonitor", "description", MonitorTypeValueReader.getValue(PortMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.PortMonitor", "title", MonitorTypeValueReader.getValue(PortMonitor.class.getName(), MonitorTypeValueReader.TITLE));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.PortMonitor", "target", MonitorTypeValueReader.getValue(PortMonitor.class.getName(), MonitorTypeValueReader.TARGET));
        //setClassProperty("com.dragonflow.StandardMonitor.PortMonitor", "target", "_hostname");
        
        setClassProperty("com.dragonflow.StandardMonitor.PortMonitor", "topazName", MonitorTypeValueReader.getValue(PortMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
        //setClassProperty("com.dragonflow.StandardMonitor.PortMonitor", "topazName", "Port");
        
        setClassProperty("com.dragonflow.StandardMonitor.PortMonitor", "topazType", MonitorTypeValueReader.getValue(PortMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
