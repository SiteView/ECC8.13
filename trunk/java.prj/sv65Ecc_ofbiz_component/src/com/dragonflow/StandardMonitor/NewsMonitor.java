...
public class NewsMonitor extends AtomicMonitor
{
    ...
    static 
    {
    	pServer = new StringProperty("_server", "", MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_server", MonitorIniValueReader.UNIT));
        //pServer = new StringProperty("_server", "", "news server");
    	String server_description = MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_server", MonitorIniValueReader.DESCRIPTION);
    	server_description = server_description.replaceAll("1%", Platform.exampleDomain);
    	pServer.setDisplayText(MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_server", MonitorIniValueReader.LABEL), server_description);
        ...
        pNewsGroups.setDisplayText(MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_newsgroups", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_newsgroups", MonitorIniValueReader.DESCRIPTION));
        ...
        pTimeout = new NumericProperty("_timeout", "60", MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_timeout", MonitorIniValueReader.UNIT));
        //pTimeout = new NumericProperty("_timeout", "60", "seconds");
        pTimeout.setDisplayText(MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_timeout", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_timeout", MonitorIniValueReader.DESCRIPTION));
        ...
        pUserName.setDisplayText(MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_username", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_username", MonitorIniValueReader.DESCRIPTION));
        ...
        pPassword.setDisplayText(MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_password", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_password", MonitorIniValueReader.DESCRIPTION));
        ...
        pLocalIP.setDisplayText(MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_localIP", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "_localIP", MonitorIniValueReader.DESCRIPTION));
        //pLocalIP.setDisplayText("Connect From", "optional IP address to connect from");
        pLocalIP.setParameterOptions(true, 6, true);
        
        pRoundTripTime = new NumericProperty("roundTripTime", "0", MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "roundTripTime", MonitorIniValueReader.UNIT));
        //pRoundTripTime = new NumericProperty("roundTripTime", "0", "milliseconds");
        pRoundTripTime.setLabel(MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "roundTripTime", MonitorIniValueReader.LABEL));
        //pRoundTripTime.setLabel("round trip time");
        pRoundTripTime.setStateOptions(1);
        
        pArticleCount = new NumericProperty("articleCount", "0", MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "articleCount", MonitorIniValueReader.UNIT));
        //pArticleCount = new NumericProperty("articleCount", "0", "articles");
        pArticleCount.setLabel(MonitorIniValueReader.getValue(NewsMonitor.class.getName(), "articleCount", MonitorIniValueReader.LABEL));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "description", MonitorTypeValueReader.getValue(NewsMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "title", MonitorTypeValueReader.getValue(NewsMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "target", MonitorTypeValueReader.getValue(NewsMonitor.class.getName(), MonitorTypeValueReader.TARGET));
        //setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "target", "_server");
        
        setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "toolName", MonitorTypeValueReader.getValue(NewsMonitor.class.getName(), MonitorTypeValueReader.TOOLNAME));
        //setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "toolName", "Check News Server");
        
        setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "toolDescription", MonitorTypeValueReader.getValue(NewsMonitor.class.getName(), MonitorTypeValueReader.TOOLDESCRIPTION));
        //setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "toolDescription", "Check whether a News Server is operational.");
        
        setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "classType", MonitorTypeValueReader.getValue(NewsMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
        //setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "classType", "advanced");
        
        setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "topazName", MonitorTypeValueReader.getValue(NewsMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
        //setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "topazName", "NNTP");
        
        setClassProperty("com.dragonflow.StandardMonitor.NewsMonitor", "topazType", MonitorTypeValueReader.getValue(NewsMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
