...
public class MonitorLoadMonitor extends MultiContentBase {
    ...
    static {
        ...
        pCounters = new StringProperty("_counters", getTemplateContent(getTemplatePath(), templateFile, false), MonitorIniValueReader.getValue(MonitorLoadMonitor.class.getName(), "_counters", MonitorIniValueReader.UNIT));
        ...
        String counters_description = MonitorIniValueReader.getValue(MonitorLoadMonitor.class.getName(), "_counters", MonitorIniValueReader.DESCRIPTION);
        try {
        	...
        	pCounters.setDisplayText(MonitorIniValueReader.getValue(MonitorLoadMonitor.class.getName(), "_counters", MonitorLoadMonitor.LAST_BASE_MEASUREMENT_NAME_PREFIX), counters_description);
        ...
        setClassProperty(s, "description", MonitorTypeValueReader.getValue(MonitorLoadMonitor.class.getName(), MonitorTypeValueReader.DEFAULTFREQUENCY));
        //setClassProperty(s, "description", "Monitors monitor load");
        
        setClassProperty(s, "title", MonitorTypeValueReader.getValue(MonitorLoadMonitor.class.getName(), MonitorTypeValueReader.TITLE));
        //setClassProperty(s, "title", "Monitor Load Monitor");
        
        setClassProperty(s, "help", "MonitorLoadMonitor.htm");
        
        setClassProperty(s, "target", MonitorTypeValueReader.getValue(MonitorLoadMonitor.class.getName(), MonitorTypeValueReader.TARGET));
        //setClassProperty(s, "target", "_server");
        
        setClassProperty(s, "topazName", MonitorTypeValueReader.getValue(MonitorLoadMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
        //setClassProperty(s, "topazName", "Monitor Load Monitor");
        
        setClassProperty(s, "classType", MonitorTypeValueReader.getValue(MonitorLoadMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
        //setClassProperty(s, "classType", "application");
        
        setClassProperty(s, "applicationType", MonitorTypeValueReader.getValue(MonitorLoadMonitor.class.getName(), MonitorTypeValueReader.APPLICATIONTYPE));
