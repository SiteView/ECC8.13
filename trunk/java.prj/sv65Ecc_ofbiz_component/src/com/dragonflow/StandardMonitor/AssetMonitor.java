...
/*
    ...
    int logAssets(Array array, StringBuffer stringbuffer) {
        ...
        if (s.equals("server")) {
            ...
            array4.pushFront(s2);
            array4.add(EntityLogger.dateFormat(Platform.makeDate()));
            EntityLogger.logger.logCustom(this, array4, "server_asset", server_asset_create, server_asset_define, server_asset_insert);
        } else if (s.equals("service")) {
            Array array6;
            for (Enumeration enumeration2 = array3.elements(); enumeration2.hasMoreElements(); EntityLogger.logger.logCustom(this, array6, "service_asset", service_asset_create, service_asset_create2, service_asset_define, service_asset_insert)) {
                Object obj1 = enumeration2.nextElement();
                array6 = splitRecord(obj1);
                array6.pushFront(s2);
                array6.add(EntityLogger.dateFormat(Platform.makeDate()));
            }

        } else if (s.equals("software")) {
            Array array7;
            for (Enumeration enumeration3 = array3.elements(); enumeration3.hasMoreElements(); EntityLogger.logger.logCustom(this, array7, "software_asset", software_asset_create, software_asset_create2, software_asset_define, software_asset_insert)) {
                Object obj2 = enumeration3.nextElement();
                array7 = splitRecord(obj2);
                array7.pushFront(s2);
                array7.add(EntityLogger.dateFormat(Platform.makeDate()));
            }

        } else if (s.equals("drive")) {
            Array array8;
            for (Enumeration enumeration4 = array3.elements(); enumeration4.hasMoreElements(); EntityLogger.logger.logCustom(this, array8, "drive_asset", drive_asset_create, drive_asset_define, drive_asset_insert)) {
                Object obj3 = enumeration4.nextElement();
                array8 = splitRecord(obj3);
                array8.pushFront(s2);
                array8.add(EntityLogger.dateFormat(Platform.makeDate()));
            }

        } else if (s.equals("nic")) {
            Array array9;
            for (Enumeration enumeration5 = array3.elements(); enumeration5.hasMoreElements(); EntityLogger.logger.logCustom(this, array9, "nic_asset", nic_asset_create, nic_asset_define, nic_asset_insert)) {
                Object obj4 = enumeration5.nextElement();
                array9 = splitRecord(obj4);
                array9.pushFront(s2);
                array9.add(EntityLogger.dateFormat(Platform.makeDate()));
            }
            ...
            array5.pushFront(s2);
            array5.add(EntityLogger.dateFormat(Platform.makeDate()));
            EntityLogger.logger.logCustom(this, array5, "unix_server_asset", unix_server_asset_create, unix_server_asset_define, unix_server_asset_insert);
        } else if (s.equals("unix_procs")) {
            Array array10;
            for (Enumeration enumeration7 = array3.elements(); enumeration7.hasMoreElements(); EntityLogger.logger.logCustom(this, array10, "unix_procs", unix_procs_create, unix_procs_define, unix_procs_insert)) {
                Object obj5 = enumeration7.nextElement();
                array10 = splitRecord(obj5);
                array10.pushFront(s2);
                array10.add(EntityLogger.dateFormat(Platform.makeDate()));
            }

        } else if (s.equals("unix_patch")) {
            Array array11;
            for (Enumeration enumeration8 = array3.elements(); enumeration8.hasMoreElements(); EntityLogger.logger.logCustom(this, array11, "unix_patch", unix_patch_create, unix_patch_define, unix_patch_insert)) {
                Object obj6 = enumeration8.nextElement();
                array11 = splitRecord(obj6);
                array11.pushFront(s2);
                array11.add(EntityLogger.dateFormat(Platform.makeDate()));
            }

        } else if (s.equals("unix_package")) {
            Array array12;
            for (Enumeration enumeration9 = array3.elements(); enumeration9.hasMoreElements(); EntityLogger.logger.logCustom(this, array12, "unix_package", unix_package_create, unix_package_create2, unix_package_create3, unix_package_define,
                    unix_package_insert)) {
                Object obj7 = enumeration9.nextElement();
                array12 = splitRecord(obj7);
                array12.pushFront(s2);
                array12.add(EntityLogger.dateFormat(Platform.makeDate()));
            }

        } else if (s.equals("unix_drive")) {
            Array array13;
            for (Enumeration enumeration10 = array3.elements(); enumeration10.hasMoreElements(); EntityLogger.logger.logCustom(this, array13, "unix_drive_asset", unix_drive_asset_create, unix_drive_asset_define, unix_drive_asset_insert)) {
                Object obj8 = enumeration10.nextElement();
                array13 = splitRecord(obj8);
                array13.pushFront(s2);
                array13.add(EntityLogger.dateFormat(Platform.makeDate()));
            }

        } else if (s.equals("unix_nic")) {
            Array array14;
            for (Enumeration enumeration11 = array3.elements(); enumeration11.hasMoreElements(); EntityLogger.logger.logCustom(this, array14, "unix_nic_asset", unix_nic_asset_create, unix_nic_asset_define, unix_nic_asset_insert)) {
                Object obj9 = enumeration11.nextElement();
                array14 = splitRecord(obj9);
                array14.pushFront(s2);
                array14.add(EntityLogger.dateFormat(Platform.makeDate()));
            }
    ...
    static {
        ...
        pAsset.setDisplayText(MonitorIniValueReader.getValue(AssetMonitor.class.getName(), "_asset", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(AssetMonitor.class.getName(), "_asset", MonitorIniValueReader.DESCRIPTION));
        ...
        pExpression.setDisplayText(MonitorIniValueReader.getValue(AssetMonitor.class.getName(), "_expression", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(AssetMonitor.class.getName(), "_expression", MonitorIniValueReader.DESCRIPTION));
        ...
        pMaxMeasurement = new NumericProperty("_maxMeasurement", "0", MonitorIniValueReader.getValue(AssetMonitor.class.getName(), "_maxMeasurement", MonitorIniValueReader.UNIT));
        //pMaxMeasurement = new NumericProperty("_maxMeasurement", "0", "milleseconds");
        pMaxMeasurement.setDisplayText(MonitorIniValueReader.getValue(AssetMonitor.class.getName(), "_maxMeasurement", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(AssetMonitor.class.getName(), "_maxMeasurement", MonitorIniValueReader.DESCRIPTION));
        //pMaxMeasurement.setDisplayText("Maximum for Measurement","optional value to specify as maximum for gauge display in milleseconds (example: if the runtime of the script is 4 seconds and this value is set at 8 seconds (8000ms) than the gauge will show at 50%");
        pMaxMeasurement.setParameterOptions(true, 2, true);
        
        pRoundTripTime = new NumericProperty("roundTripTime", "0", MonitorIniValueReader.getValue(AssetMonitor.class.getName(), "roundTripTime", MonitorIniValueReader.UNIT));
        //pRoundTripTime = new NumericProperty("roundTripTime", "0", "milliseconds");
        pRoundTripTime.setLabel(MonitorIniValueReader.getValue(AssetMonitor.class.getName(), "roundTripTime", MonitorIniValueReader.LABEL));
        //pRoundTripTime.setLabel("round trip time");
        pRoundTripTime.setStateOptions(1);
        
        pStatus = new StringProperty("status");
        pRoundTripTime.setLabel(MonitorIniValueReader.getValue(AssetMonitor.class.getName(), "status", MonitorIniValueReader.LABEL));
        //pStatus.setLabel("status");
        pStatus.setStateOptions(2);
        
        pRecords = new StringProperty("records");
        pRoundTripTime.setLabel(MonitorIniValueReader.getValue(AssetMonitor.class.getName(), "records", MonitorIniValueReader.LABEL));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.AssetMonitor", "description",MonitorTypeValueReader.getValue(AssetMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.AssetMonitor", "title", MonitorTypeValueReader.getValue(AssetMonitor.class.getName(), MonitorTypeValueReader.TITLE));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.AssetMonitor", "target", MonitorTypeValueReader.getValue(AssetMonitor.class.getName(), MonitorTypeValueReader.TARGET));
        //setClassProperty("com.dragonflow.StandardMonitor.AssetMonitor", "target", "_asset");
        
        setClassProperty("com.dragonflow.StandardMonitor.AssetMonitor", "classType", MonitorTypeValueReader.getValue(AssetMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
        //setClassProperty("com.dragonflow.StandardMonitor.AssetMonitor", "classType", "advanced");
        
        setClassProperty("com.dragonflow.StandardMonitor.AssetMonitor", "topazName", MonitorTypeValueReader.getValue(AssetMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
        //setClassProperty("com.dragonflow.StandardMonitor.AssetMonitor", "topazName", "Asset");
        
        setClassProperty("com.dragonflow.StandardMonitor.AssetMonitor", "topazType", MonitorTypeValueReader.getValue(AssetMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
