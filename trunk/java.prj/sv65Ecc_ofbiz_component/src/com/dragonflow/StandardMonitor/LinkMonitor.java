...
public class LinkMonitor extends AtomicMonitor
{
    ...
    static 
    {
        ...
        String url_description=MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_url", MonitorIniValueReader.DESCRIPTION);
        url_description=url_description.replaceAll("1%", Platform.exampleDomain);
        pURL.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_url", MonitorIniValueReader.LABEL), url_description);
        ...
        pPause = new NumericProperty("_pause", "250", MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_pause", MonitorIniValueReader.UNIT));
        //pPause = new NumericProperty("_pause", "250", "milliseconds");
        pPause.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_pause", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_pause", MonitorIniValueReader.DESCRIPTION));
        //pPause.setDisplayText("Pause", "delay between checks, in milliseconds");
        pPause.setParameterOptions(true, 1, true);
        
        pMaxLinks = new NumericProperty("_maxLinks", "800", MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_maxLinks", MonitorIniValueReader.UNIT));
        //pMaxLinks = new NumericProperty("_maxLinks", "800", "links");
        pMaxLinks.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_maxLinks", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_maxLinks", MonitorIniValueReader.DESCRIPTION));
        ...
        pMaxSearchDepth.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_maxSearchDepth", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_maxSearchDepth", MonitorIniValueReader.DESCRIPTION));
        ...
        pReport.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_report", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_report", MonitorIniValueReader.DESCRIPTION));
        ...
        pTimeout = new NumericProperty("_timeout", "60", MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_timeout", MonitorIniValueReader.UNIT));
        //pTimeout = new NumericProperty("_timeout", "60", "seconds");
        pTimeout.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_timeout", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_timeout", MonitorIniValueReader.DESCRIPTION));
        ...
        String proxy_description=MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_proxy", MonitorIniValueReader.DESCRIPTION);
        proxy_description=proxy_description.replaceAll("1%", Platform.exampleDomain);
        pProxy.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_proxy", MonitorIniValueReader.LABEL), proxy_description );
        ...
        pChallengeResponse.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_challengeResponse", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_challengeResponse", MonitorIniValueReader.DESCRIPTION));
        ...
        pUserName.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_username", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_username", MonitorIniValueReader.DESCRIPTION));
        ...
        pPassword.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_password", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_password", MonitorIniValueReader.DESCRIPTION));
        ...
        pProxyUserName.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_proxyusername", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_proxyusername", MonitorIniValueReader.DESCRIPTION));
        ...
        pProxyPassword.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_proxypassword", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_proxypassword", MonitorIniValueReader.DESCRIPTION));
        ...
        pPostData = new StringProperty("_postData", "", MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_postData", MonitorIniValueReader.UNIT));
        //pPostData = new StringProperty("_postData", "", "POST Variables");
        pPostData.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_postData", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_postData", MonitorIniValueReader.DESCRIPTION));
        ...
        pExternalLinks.setDisplayText(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_externalLinks", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "_externalLinks", MonitorIniValueReader.DESCRIPTION));
        ...
        pLinkErrors = new NumericProperty("linkErrors", "0", MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "linkErrors", MonitorIniValueReader.UNIT));
        //pLinkErrors = new NumericProperty("linkErrors", "0", "errors");
        pLinkErrors.setLabel(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "linkErrors", MonitorIniValueReader.LABEL));
        //pLinkErrors.setLabel("link errors");
        pLinkErrors.setStateOptions(1);
        
        pTotalPages = new NumericProperty("links", "0", MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "links", MonitorIniValueReader.UNIT));
        //pTotalPages = new NumericProperty("links", "0", "links");
        pTotalPages.setLabel(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "links", MonitorIniValueReader.LABEL));
        //pTotalPages.setLabel("total links");
        pTotalPages.setStateOptions(2);
        
        pAverage = new NumericProperty("average", "0", MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "average", MonitorIniValueReader.UNIT));
        //pAverage = new NumericProperty("average", "0", "milliseconds");
        pAverage.setLabel(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "average", MonitorIniValueReader.LABEL));
        //pAverage.setLabel("average");
        pAverage.setStateOptions(2);
        
        pTotalGraphics = new NumericProperty("graphics", "0", MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "graphics", MonitorIniValueReader.UNIT));
        //pTotalGraphics = new NumericProperty("graphics", "0", "links");
        pTotalGraphics.setLabel(MonitorIniValueReader.getValue(LinkMonitor.class.getName(), "graphics", MonitorIniValueReader.LABEL));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "description", MonitorTypeValueReader.getValue(LinkMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "title", MonitorTypeValueReader.getValue(LinkMonitor.class.getName(), MonitorTypeValueReader.TITLE));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "target", MonitorTypeValueReader.getValue(LinkMonitor.class.getName(), MonitorTypeValueReader.TARGET));
        //setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "target", "_url");
        
        setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "classType", MonitorTypeValueReader.getValue(LinkMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
        //setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "classType", "advanced");
        
        setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "defaultFrequency", MonitorTypeValueReader.getValue(LinkMonitor.class.getName(), MonitorTypeValueReader.DEFAULTFREQUENCY));
        setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "defaultFrequency", "86400");
        
        setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "toolPageDisable", MonitorTypeValueReader.getValue(LinkMonitor.class.getName(), MonitorTypeValueReader.TOOLPAGEDISABLE));
        //setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "toolPageDisable", "true");
        
        setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "topazName", MonitorTypeValueReader.getValue(LinkMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
        //setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "topazName", "Link Monitor");
        
        setClassProperty("com.dragonflow.StandardMonitor.LinkMonitor", "topazType", MonitorTypeValueReader.getValue(LinkMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
