...
//        MasterConfig.saveMasterConfig(hashmap);
        Config.configPut("_BrowsableWMIMaxCounters", (new Integer(i)).toString());
    }
...
//    }
    ...
    static {
        ...
        pHost.setDisplayText(MonitorIniValueReader.getValue(BrowsableWMIMonitor.class.getName(), "_host", MonitorIniValueReader.LABEL),MonitorIniValueReader.getValue(BrowsableWMIMonitor.class.getName(), "_host", MonitorIniValueReader.DESCRIPTION));
        //pHost.setDisplayText("Server", "");
        pHost.setParameterOptions(false, 1, false);
        
        pFile = new ScalarProperty("_browsefile");
        pFile.setDisplayText(MonitorIniValueReader.getValue(BrowsableWMIMonitor.class.getName(), "_browsefile", MonitorIniValueReader.LABEL),MonitorIniValueReader.getValue(BrowsableWMIMonitor.class.getName(), "_browsefile", MonitorIniValueReader.DESCRIPTION));
        ...
        pUsername.setDisplayText(MonitorIniValueReader.getValue(BrowsableWMIMonitor.class.getName(), "_username", MonitorIniValueReader.LABEL),MonitorIniValueReader.getValue(BrowsableWMIMonitor.class.getName(), "_username", MonitorIniValueReader.DESCRIPTION));
        //pUsername.setDisplayText("Username", "");
        pUsername.setParameterOptions(true, 3, false);
        
        pPassword = new StringProperty("_password");
        pPassword.setDisplayText(MonitorIniValueReader.getValue(BrowsableWMIMonitor.class.getName(), "_password", MonitorIniValueReader.LABEL),MonitorIniValueReader.getValue(BrowsableWMIMonitor.class.getName(), "_password", MonitorIniValueReader.DESCRIPTION));
        ...
        setClassProperty(s, "description", MonitorTypeValueReader.getValue(BrowsableWMIMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        //setClassProperty(s, "description", "WMI metrics");
        
        setClassProperty(s, "title", MonitorTypeValueReader.getValue(BrowsableWMIMonitor.class.getName(), MonitorTypeValueReader.TITLE));
