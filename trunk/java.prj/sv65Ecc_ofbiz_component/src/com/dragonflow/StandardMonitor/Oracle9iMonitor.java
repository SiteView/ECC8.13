...
public class Oracle9iMonitor extends URLContentBase
{
    ...
    static 
    {
        ...
        pCounters = new StringProperty("_apacheCounters", getTemplateContent(getTemplatePath(), templateFile, true), MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_apacheCounters", MonitorIniValueReader.UNIT));
        ...
        String apachecounters_description = MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_apacheCounters", MonitorIniValueReader.DESCRIPTION);
        apachecounters_description = apachecounters_description.replaceAll("1%", URLEncoder.encode(returnURL));
        apachecounters_description = apachecounters_description.replaceAll("2%", ""+nMaxCounters);
        apachecounters_description = apachecounters_description.replaceAll("3%", templateFile);
        pCounters.setDisplayText(MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_apacheCounters", MonitorIniValueReader.LABEL), apachecounters_description);
        ...
        pURL.setDisplayText(MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_url", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_url", MonitorIniValueReader.DESCRIPTION));
        ...
        pTimeout = new NumericProperty("_timeout", "60", MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_timeout", MonitorIniValueReader.UNIT));
        //pTimeout = new NumericProperty("_timeout", "60", "seconds");
        pTimeout.setDisplayText(MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_timeout", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_timeout", MonitorIniValueReader.DESCRIPTION));
        ...
        String proxy_description = MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_proxy", MonitorIniValueReader.DESCRIPTION);
        proxy_description = proxy_description.replaceAll("1%", Platform.exampleDomain);
        pProxy.setDisplayText(MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_proxy", MonitorIniValueReader.LABEL), proxy_description);
        ...
        pUserName.setDisplayText(MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_username", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_username", MonitorIniValueReader.DESCRIPTION));
        ...
        pPassword.setDisplayText(MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_password", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_password", MonitorIniValueReader.DESCRIPTION));
        ...
        pChallengeResponse.setDisplayText(MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_challengeResponse", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_challengeResponse", MonitorIniValueReader.DESCRIPTION));
        ...
        pProxyUserName.setDisplayText(MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_proxyusername", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_proxyusername", MonitorIniValueReader.DESCRIPTION));
        ...
        pProxyPassword.setDisplayText(MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_proxypassword", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(Oracle9iMonitor.class.getName(), "_proxypassword", MonitorIniValueReader.DESCRIPTION));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.Oracle9iMonitor", "description", MonitorTypeValueReader.getValue(Oracle9iMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.Oracle9iMonitor", "title", MonitorTypeValueReader.getValue(Oracle9iMonitor.class.getName(), MonitorTypeValueReader.TITLE));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.Oracle9iMonitor", "target", MonitorTypeValueReader.getValue(Oracle9iMonitor.class.getName(), MonitorTypeValueReader.TARGET));
        //setClassProperty("com.dragonflow.StandardMonitor.Oracle9iMonitor", "target", "_url");
        
        setClassProperty("com.dragonflow.StandardMonitor.Oracle9iMonitor", "topazName", MonitorTypeValueReader.getValue(Oracle9iMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
        //setClassProperty("com.dragonflow.StandardMonitor.Oracle9iMonitor", "topazName", "Oracle9iAS HTTP Server");
        
        setClassProperty("com.dragonflow.StandardMonitor.Oracle9iMonitor", "topazType", MonitorTypeValueReader.getValue(Oracle9iMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
        //setClassProperty("com.dragonflow.StandardMonitor.Oracle9iMonitor", "topazType", "Web Server");
        
        setClassProperty("com.dragonflow.StandardMonitor.Oracle9iMonitor", "classType", MonitorTypeValueReader.getValue(Oracle9iMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
        //setClassProperty("com.dragonflow.StandardMonitor.Oracle9iMonitor", "classType", "application");
        
        setClassProperty("com.dragonflow.StandardMonitor.Oracle9iMonitor", "applicationType", MonitorTypeValueReader.getValue(Oracle9iMonitor.class.getName(), MonitorTypeValueReader.APPLICATIONTYPE));
