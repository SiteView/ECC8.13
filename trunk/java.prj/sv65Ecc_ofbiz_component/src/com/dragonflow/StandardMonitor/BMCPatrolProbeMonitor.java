...
//     BMCPatrolLoggerRepository.getLogger(LoggerCategory.MONITOR).debug("BMC Patrol Static Initialization Routine");
     ...
     //pEmsIntegrationState.setLabel(MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "pEmsIntegrationState", MonitorIniValueReader.LABEL));
     //pEmsIntegrationState.setLabel("EmsIntegrationState");
     pEmsIntegrationState.setDisplayText(MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "pEmsIntegrationState", MonitorIniValueReader.LABEL),MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "pEmsIntegrationState", MonitorIniValueReader.DESCRIPTION));
     ...
     pPTIServerPort.setDisplayText(MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "_ptiPort", MonitorIniValueReader.LABEL),MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "_ptiPort", MonitorIniValueReader.DESCRIPTION));
     ...
     pUsePatrolApiInsteadOfPconfig.setDisplayText(MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "_pBmcPatrolApi", MonitorIniValueReader.LABEL),MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "_pBmcPatrolApi", MonitorIniValueReader.DESCRIPTION));
     ...
     pDisableUDP.setDisplayText(MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "_pBmcDisableUDP", MonitorIniValueReader.LABEL),MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "_pBmcDisableUDP", MonitorIniValueReader.DESCRIPTION));
     ...
     pBmcAgentPort.setDisplayText(MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "_pBmcAgentPort", MonitorIniValueReader.LABEL),MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "_pBmcAgentPort", MonitorIniValueReader.DESCRIPTION));
     ...
     pOptionalUserNameForPconfig.setDisplayText(MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "_pBmcUserName", MonitorIniValueReader.LABEL),MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "_pBmcUserName", MonitorIniValueReader.DESCRIPTION));
     ...
     pPasswordForPconfig.setDisplayText(MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "_pBmcPassword", MonitorIniValueReader.LABEL),MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "_pBmcPassword", MonitorIniValueReader.DESCRIPTION));
     ...
     pTotalMessageCount.setLabel(MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "totalMessageCount", MonitorIniValueReader.LABEL));
     ...
     pCurrentlyConnectedPTIs.setDisplayText(MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "pCurrentlyConnectedPTIs", MonitorIniValueReader.LABEL),MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "pCurrentlyConnectedPTIs", MonitorIniValueReader.DESCRIPTION));
     //pCurrentlyConnectedPTIs.setDisplayText("", "");
     
     pNumOfConnectedPTIs = new NumericProperty("numOfConnectedPTIs");
     pNumOfConnectedPTIs.setLabel(MonitorIniValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), "numOfConnectedPTIs", MonitorIniValueReader.LABEL));
     ...
     PropertiedObject.setClassProperty("com.dragonflow.StandardMonitor.BMCPatrolProbeMonitor", "description", MonitorTypeValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
     ...
     PropertiedObject.setClassProperty("com.dragonflow.StandardMonitor.BMCPatrolProbeMonitor", "title", MonitorTypeValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), MonitorTypeValueReader.TITLE));
     ...
     PropertiedObject.setClassProperty("com.dragonflow.StandardMonitor.BMCPatrolProbeMonitor", "topazName", MonitorTypeValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
     //PropertiedObject.setClassProperty("com.dragonflow.StandardMonitor.BMCPatrolProbeMonitor", "topazName", "BMC Patrol Alerts");
     
     PropertiedObject.setClassProperty("com.dragonflow.StandardMonitor.BMCPatrolProbeMonitor", "topazType", MonitorTypeValueReader.getValue(BMCPatrolProbeMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
