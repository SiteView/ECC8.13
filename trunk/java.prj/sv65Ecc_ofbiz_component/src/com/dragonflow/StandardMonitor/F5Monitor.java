...
public class F5Monitor extends BrowsableSNMPBase
{
 ...
 static 
 {
     ...
     setClassProperty("com.dragonflow.StandardMonitor.F5Monitor", "description", MonitorTypeValueReader.getValue(F5Monitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
     ...
     setClassProperty("com.dragonflow.StandardMonitor.F5Monitor", "title", MonitorTypeValueReader.getValue(F5Monitor.class.getName(), MonitorTypeValueReader.TITLE));
     ...
     setClassProperty("com.dragonflow.StandardMonitor.F5Monitor", "target", MonitorTypeValueReader.getValue(F5Monitor.class.getName(), MonitorTypeValueReader.TARGET));
     //setClassProperty("com.dragonflow.StandardMonitor.F5Monitor", "target", "_server");
     
     setClassProperty("com.dragonflow.StandardMonitor.F5Monitor", "topazName", MonitorTypeValueReader.getValue(F5Monitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
     //setClassProperty("com.dragonflow.StandardMonitor.F5Monitor", "topazName", "F5");
     
     setClassProperty("com.dragonflow.StandardMonitor.F5Monitor", "classType", MonitorTypeValueReader.getValue(F5Monitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
     //setClassProperty("com.dragonflow.StandardMonitor.F5Monitor", "classType", "application");
     
     setClassProperty("com.dragonflow.StandardMonitor.F5Monitor", "topazType", MonitorTypeValueReader.getValue(F5Monitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
     //setClassProperty("com.dragonflow.StandardMonitor.F5Monitor", "topazType", "Load Balancer");
     
     setClassProperty("com.dragonflow.StandardMonitor.F5Monitor", "loadable", MonitorTypeValueReader.getValue(F5Monitor.class.getName(), MonitorTypeValueReader.LOADABLE));
