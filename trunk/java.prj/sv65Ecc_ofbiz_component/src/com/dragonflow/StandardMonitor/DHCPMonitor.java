...
public class DHCPMonitor extends AtomicMonitor {
    ...
    static {
    	pTimeout = new NumericProperty("_timeout", "10", MonitorIniValueReader.getValue(DHCPMonitor.class.getName(), "_timeout", MonitorIniValueReader.UNIT));
        //pTimeout = new NumericProperty("_timeout", "10", "seconds");
    	pTimeout.setDisplayText(MonitorIniValueReader.getValue(DHCPMonitor.class.getName(), "_timeout", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(DHCPMonitor.class.getName(), "_timeout", MonitorIniValueReader.DESCRIPTION));
        ...
        pRequestAddress.setDisplayText(MonitorIniValueReader.getValue(DHCPMonitor.class.getName(), "_requestAddress", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(DHCPMonitor.class.getName(), "_requestAddress", MonitorIniValueReader.DESCRIPTION));
        ...
        pRoundTripTime = new NumericProperty("roundTripTime", "0", MonitorIniValueReader.getValue(DHCPMonitor.class.getName(), "roundTripTime", MonitorIniValueReader.UNIT));
        //pRoundTripTime = new NumericProperty("roundTripTime", "0", "milliseconds");
        pRoundTripTime.setLabel(MonitorIniValueReader.getValue(DHCPMonitor.class.getName(), "roundTripTime", MonitorIniValueReader.LABEL));
        ...
        pLeaseAddress.setLabel(MonitorIniValueReader.getValue(DHCPMonitor.class.getName(), "leasedAddress", MonitorIniValueReader.LABEL));
        //pLeaseAddress.setLabel("Leased IP Address");
        
        pStatus = new StringProperty("status");
        pStatus.setLabel(MonitorIniValueReader.getValue(DHCPMonitor.class.getName(), "status", MonitorIniValueReader.LABEL));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "description", MonitorTypeValueReader.getValue(DHCPMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "title", MonitorTypeValueReader.getValue(DHCPMonitor.class.getName(), MonitorTypeValueReader.TITLE));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "classType", MonitorTypeValueReader.getValue(DHCPMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
        //setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "classType", "server");
        
        setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "target", MonitorTypeValueReader.getValue(DHCPMonitor.class.getName(), MonitorTypeValueReader.TARGET));
        //setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "target", "_hostname");
        
        setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "topazName", MonitorTypeValueReader.getValue(DHCPMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
        //setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "topazName", "DHCP");
        
        setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "topazType", MonitorTypeValueReader.getValue(DHCPMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
        //setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "topazType", "System Resources");
        
        setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "toolPageDisable", MonitorTypeValueReader.getValue(DHCPMonitor.class.getName(), MonitorTypeValueReader.TOOLPAGEDISABLE));
        //setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "toolPageDisable", "true");
        
        setClassProperty("com.dragonflow.StandardMonitor.DHCPMonitor", "loadable", MonitorTypeValueReader.getValue(DHCPMonitor.class.getName(), MonitorTypeValueReader.LOADABLE));
