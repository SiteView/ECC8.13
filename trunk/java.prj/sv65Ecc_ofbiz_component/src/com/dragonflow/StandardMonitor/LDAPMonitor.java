...
public class LDAPMonitor extends AtomicMonitor
{
    ...
    static 
    {
        ...
        pURLProvider.setDisplayText(MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "_urlprovider", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "_urlprovider", MonitorIniValueReader.DESCRIPTION));
        ...
        pSecurityPrincipal.setDisplayText(MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "_securityprincipal", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "_securityprincipal", MonitorIniValueReader.DESCRIPTION));
        ...
        pSecurityCredential.setDisplayText(MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "_password", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "_password", MonitorIniValueReader.DESCRIPTION));
        ...
        pMatchString.setDisplayText(MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "_matchstring", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "_matchstring", MonitorIniValueReader.DESCRIPTION));
        ...
        pLdapQuery.setDisplayText(MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "_ldapquery", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "_ldapquery", MonitorIniValueReader.DESCRIPTION));
        ...
        pLdapFilter.setDisplayText(MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "_ldapfilter", MonitorIniValueReader.LABEL), MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "_ldapfilter", MonitorIniValueReader.DESCRIPTION));
        ...
        pRoundTripTime = new NumericProperty("roundTripTime", "0", MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "roundTripTime", MonitorIniValueReader.UNIT));
        //pRoundTripTime = new NumericProperty("roundTripTime", "0", "milliseconds");
        pRoundTripTime.setLabel(MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "roundTripTime", MonitorIniValueReader.LABEL));
        //pRoundTripTime.setLabel("round trip time");
        pRoundTripTime.setStateOptions(1);
        
        pStatus = new StringProperty("status");
        pStatus.setLabel(MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "status", MonitorIniValueReader.LABEL));
        //pStatus.setLabel("status");
        pStatus.setStateOptions(2);
        
        pMatchValue = new StringProperty("matchValue");
        pMatchValue.setLabel(MonitorIniValueReader.getValue(LDAPMonitor.class.getName(), "matchValue", MonitorIniValueReader.LABEL));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.LDAPMonitor", "description", MonitorTypeValueReader.getValue(LDAPMonitor.class.getName(), MonitorTypeValueReader.DESCRIPTION));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.LDAPMonitor", "title", MonitorTypeValueReader.getValue(LDAPMonitor.class.getName(), MonitorTypeValueReader.TITLE));
        ...
        setClassProperty("com.dragonflow.StandardMonitor.LDAPMonitor", "classType", MonitorTypeValueReader.getValue(LDAPMonitor.class.getName(), MonitorTypeValueReader.CLASSTYPE));
        //setClassProperty("com.dragonflow.StandardMonitor.LDAPMonitor", "classType", "advanced");
        
        setClassProperty("com.dragonflow.StandardMonitor.LDAPMonitor", "toolName", MonitorTypeValueReader.getValue(LDAPMonitor.class.getName(), MonitorTypeValueReader.TOOLNAME));
        //setClassProperty("com.dragonflow.StandardMonitor.LDAPMonitor", "toolName", "LDAP Authentication");
        
        setClassProperty("com.dragonflow.StandardMonitor.LDAPMonitor", "toolDescription", MonitorTypeValueReader.getValue(LDAPMonitor.class.getName(), MonitorTypeValueReader.TOOLDESCRIPTION));
        //setClassProperty("com.dragonflow.StandardMonitor.LDAPMonitor", "toolDescription", "Test an LDAP server by authenticating a user.");
        
        setClassProperty("com.dragonflow.StandardMonitor.LDAPMonitor", "topazName", MonitorTypeValueReader.getValue(LDAPMonitor.class.getName(), MonitorTypeValueReader.TOPAZNAME));
        //setClassProperty("com.dragonflow.StandardMonitor.LDAPMonitor", "topazName", "LDAP Monitor");
        
        setClassProperty("com.dragonflow.StandardMonitor.LDAPMonitor", "topazType", MonitorTypeValueReader.getValue(LDAPMonitor.class.getName(), MonitorTypeValueReader.TOPAZTYPE));
