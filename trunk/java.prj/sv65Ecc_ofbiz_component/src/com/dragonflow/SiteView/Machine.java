...
public class Machine extends SiteViewObject {
        ...
        if (machineObjectTable == null) {
            synchronized (registerMachinesLock) {
                if (machineObjectTable == null) {
                    ...
                    registerMachines(hashmap.values(new RemoteUnixInstancePreferences().getSettingName()));
                }
            }
        }
    ...
    public static void registerNTMachines(String s) {
        synchronized (ntMachineTableLock) {
            ...
            String s2;
            for (Enumeration enumeration = hashmap.values(new RemoteNTInstancePreferences().getSettingName()); enumeration
