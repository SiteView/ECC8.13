...
import com.siteview.ecc.api.MonitorStatusEntity;
import com.siteview.ecc.api.MonitorStatusHelpEntity;
...
public abstract class Monitor extends SiteViewObject {
    ...
    public Vector getScalarValues(ScalarProperty scalarproperty,
        ...
        if (scalarproperty == pSchedule) {
            ...
            HashMap hashmap;
            for (
            		Enumeration enumeration = CGI.getValues(cgi.getSettings(),"_additionalSchedule"); 
            		enumeration.hasMoreElements(); 
            		vector.addElement(TextUtils.getValue(hashmap, "_name"))
            	) {
    ...
    protected void setComputeGroupCounts(Rule rule) {
        ...
        if (s.indexOf("group.monitorsInGroup") != -1
            ...
            s = TextUtils.replaceString(s, "group.monitorsInGroup","monitorsInGroup");
            s = TextUtils.replaceString(s, "group.monitorsInError","monitorsInError");
            s = TextUtils.replaceString(s, "group.maxErrorCount","maxErrorCount");
    ...
    protected void printTableCategoryEntry(PrintWriter printwriter,
        ...
        String s2 = "";
        String s3 = "";
        String returnURL =  HTTPRequest.encodeString(I18N.UnicodeToString(getProperty(pGroupID), I18N
                .nullEncoding()));
        ...
        if (httprequest.actionAllowed("_monitorDisable")
            ...
            if (this instanceof SubGroup) {
                ...
                String groupId = I18N.toDefaultEncoding(getProperty(pGroupID));
                try {
                    Array array = CGI.ReadGroupFrames(groupId, httprequest);
                    HashMap hashmap = CGI.findMonitor(array, s5);
                    s10 = TextUtils.getValue(hashmap, "_group");
                } catch (Exception exception) {
                    System.out.println("***Couldn't get subgroup file name! parent=" + groupId);
                }
                s8 = "&group=" + HTTPRequest.encodeString(I18N.UnicodeToString(s10, I18N.nullEncoding()));
                returnLabel = getProperty("_name");
            } else {
                s7 = !flag && !flag1 ? "Disable" : "Enable";
                s8 = "&monitor=" + returnURL + "+" + s5;
    ...
    public static jgl.HashMap statusMapping = MonitorStatusEntity.getMapping();

    public static jgl.HashMap statusHelpMapping = MonitorStatusHelpEntity.getMapping();
    ...
    static {
       ...
       */
        ...
        pName.setDisplayText(MonitorIniValueReader.getCommonValue("_name", MonitorIniValueReader.LABEL),
        		MonitorIniValueReader.getCommonValue("_name", MonitorIniValueReader.DESCRIPTION));
        ...
        pDisabled.setDisplayText(MonitorIniValueReader.getCommonValue("_disabled", MonitorIniValueReader.LABEL),
        		MonitorIniValueReader.getCommonValue("_disabled", MonitorIniValueReader.DESCRIPTION));
        ...
        pVerifyError.setDisplayText(
        		MonitorIniValueReader.getCommonValue("_verifyError", MonitorIniValueReader.LABEL),
        		MonitorIniValueReader.getCommonValue("_verifyError", MonitorIniValueReader.DESCRIPTION));
        //pVerifyError.setDisplayText(
        //        "Verify Error",
        ...
        pSchedule.setDisplayText(
        		MonitorIniValueReader.getCommonValue("_schedule", MonitorIniValueReader.LABEL),
        		MonitorIniValueReader.getCommonValue("_schedule", MonitorIniValueReader.DESCRIPTION));
        //pSchedule.setDisplayText(
        //        "Schedule",
        ...
        pMonitorDescription.setDisplayText(
        		MonitorIniValueReader.getCommonValue("_monitorDescription", MonitorIniValueReader.LABEL),
        		MonitorIniValueReader.getCommonValue("_monitorDescription", MonitorIniValueReader.DESCRIPTION));
        //pMonitorDescription.setDisplayText(
        //        "Monitor Description",
        ...
        pDescription.setDisplayText(
        		MonitorIniValueReader.getCommonValue("_description", MonitorIniValueReader.LABEL),
        		MonitorIniValueReader.getCommonValue("_description", MonitorIniValueReader.DESCRIPTION));
        //pDescription.setDisplayText(
        //        "Report Description",
        ...
        pTemplateID.setDisplayText(
        		MonitorIniValueReader.getCommonValue("__template", MonitorIniValueReader.LABEL),
        		MonitorIniValueReader.getCommonValue("__template", MonitorIniValueReader.DESCRIPTION));
        ...
        pLastUpdate = new NumericProperty("last", "0", MonitorIniValueReader.getCommonValue("last", MonitorIniValueReader.UNIT));
        ...
        pNumStdDev.setLabel(MonitorIniValueReader.getCommonValue("_numStdDev", MonitorIniValueReader.LABEL));
        ...
        pNumPercent.setLabel(MonitorIniValueReader.getCommonValue("_numPercent", MonitorIniValueReader.LABEL));
        ...
        pAcknowledgedDelay = new NumericProperty("acknowledgedDelay", "0",
        		MonitorIniValueReader.getCommonValue("acknowledgedDelay", MonitorIniValueReader.UNIT));
        //pAcknowledgedDelay = new NumericProperty("acknowledgedDelay", "0",
        //						"milliseconds");
