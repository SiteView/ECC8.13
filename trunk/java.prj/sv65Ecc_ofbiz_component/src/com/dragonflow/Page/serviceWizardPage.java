        ...
        throws Exception
    {
        ...
        if(request.getValue("operation").equals("Tool"))
        {
            ...
            if(s13.length() > 0 && s3.length() > 0 && s.length() > 0)
            {
                ...
                Object aobj[] = com.dragonflow.StandardMonitor.WebServiceMonitor.rpcCall(s, s3, s4, s6, s8, s9, s11, s20, s13, stringbuffer7, stringbuffer8, s15, s21, s17, s18, s22, s16, flag2);
                int j = ((Long)aobj[0]).intValue();
                long l2 = ((Long)aobj[2]).longValue();
