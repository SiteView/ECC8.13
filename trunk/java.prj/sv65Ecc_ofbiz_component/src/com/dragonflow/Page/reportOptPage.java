...
*/
    private void updateSetting(String s)
    {
        String s1 = null;
        s1 = request.getValue(s + "CB");
        outputStream.print("<br>Debug->" + s1);
        if(s1.equalsIgnoreCase("on"))
        {
            ...
            if(s2.equalsIgnoreCase("custom"))
            {
                s2 = request.getValue(s + "Custom");
                outputStream.print("<br>Debug->" + s2);
                Config.configPut(s, s2.toUpperCase());
            } else
            {
                outputStream.print("<br>Debug->" + s2);
                Config.configPut(s, s2);
            }
        }
    }
...
*/    
        updateSetting("_reportGraphBackgroundColor");
        updateSetting("_reportGraphDisabledColor");
        updateSetting("_reportGraphErrorColor");
        updateSetting("_reportGraphGoodColor");
        updateSetting("_reportGraphMaxColor");
        updateSetting("_reportGraphNoDataColor");
        updateSetting("_reportGraphWarningColor");
        updateSetting("_reportTableDataHTML=BGCOLOR");
        updateSetting("_reportTableDisabledColor");
        updateSetting("_reportTableErrorColor");
        updateSetting("_reportTableGoodColor");
        updateSetting("_reportTableHeaderHTML");
        updateSetting("_reportTableHTML=BORDER");
        updateSetting("_reportTableNoDataColor");
        updateSetting("_reportTableWarningColor");
    }
