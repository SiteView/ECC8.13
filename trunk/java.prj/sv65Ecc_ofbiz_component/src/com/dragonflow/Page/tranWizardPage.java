...
public class tranWizardPage extends com.dragonflow.Page.monitorPage
{
    ...
    void printVars(String s)
    {
        ...
        String s1;
        for(java.util.Enumeration enumeration = request.getVariables(); enumeration.hasMoreElements(); System.out.println(s1 + "=" + request.getValue(s1)))
        {
    ...
    boolean displayList(java.util.Enumeration enumeration, String s, StringBuffer stringbuffer, boolean flag)
    {
    ...
    java.util.Enumeration getRefresh(com.dragonflow.Utils.HTMLTagParser htmltagparser, com.dragonflow.SiteView.AtomicMonitor atomicmonitor)
    {
        ...
        do
        {
            ...
            if(com.dragonflow.Utils.TextUtils.getValue(hashmap, "http-equiv").equalsIgnoreCase("refresh"))
            {
                ...
                vector.addElement(s1.length() <= displayMax ? ((Object) (s1)) : ((Object) (s1.substring(0, displayMax - 1))));
            }
        } while(true);
    ...
    java.util.Enumeration getFrames(com.dragonflow.Utils.HTMLTagParser htmltagparser, com.dragonflow.SiteView.AtomicMonitor atomicmonitor)
    {
        ...
        String s;
        for(; enumeration.hasMoreElements(); vector.addElement(s.length() <= displayMax ? ((Object) (s)) : ((Object) (s.substring(0, displayMax - 1)))))
        {
            jgl.HashMap hashmap = (jgl.HashMap)enumeration.nextElement();
        ...
        String s1;
        for(; enumeration1.hasMoreElements(); vector.addElement(s1.length() <= displayMax ? ((Object) (s1)) : ((Object) (s1.substring(0, displayMax - 1)))))
        {
    ...
    java.util.Enumeration getLinks(com.dragonflow.Utils.HTMLTagParser htmltagparser, com.dragonflow.SiteView.AtomicMonitor atomicmonitor)
    {
        java.util.Vector vector = new Vector();
        String s;
        for(java.util.Enumeration enumeration = htmltagparser.findTags("a"); enumeration.hasMoreElements(); vector.addElement(s.length() <= displayMax ? ((Object) (s)) : ((Object) (s.substring(0, displayMax - 1)))))
        {
            jgl.HashMap hashmap = (jgl.HashMap)enumeration.nextElement();
        ...
        String s1;
        for(java.util.Enumeration enumeration1 = htmltagparser.findTags("area"); enumeration1.hasMoreElements(); vector.addElement(s1.length() <= displayMax ? ((Object) (s1)) : ((Object) (s1.substring(0, displayMax - 1)))))
        {
            jgl.HashMap hashmap1 = (jgl.HashMap)enumeration1.nextElement();
            ...
            do
            {
                ...
                if(stringproperty1.getName().equals("_errorFrequency") && (stringproperty1 instanceof com.dragonflow.Properties.FrequencyProperty))
                {
                    ...
                    if(s19.length() > 0)
                    {
                        ...
                        int j4 = com.dragonflow.Properties.FrequencyProperty.toSeconds(Integer.parseInt(s19), s25);
            ...
            if(stringproperty3.isEditable && stringproperty3.isAdvanced)
            {
                if(!stringproperty3.isVariableCountProperty() || stringproperty3.shouldPrintVariableCountProperty(nextStep))
                {
                    ...
                    if(stringproperty3.isPassword)
                    {
                        ...
                        Object obj1 = hashmap1.get(stringproperty3);
