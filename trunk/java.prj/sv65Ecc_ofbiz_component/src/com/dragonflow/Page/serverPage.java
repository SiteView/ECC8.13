        ...
        } else
        {
            ...
            if(request.getValue("noNTRemote").length() == 0)
            {
                ...
                if(request.getValue("returnURL").indexOf("ScriptMonitor") > 0)
                {
                    ...
                    vector.addElement("this server");
                    vector = addNTSSHServers(vector, new RemoteNTInstancePreferences().getSettingName());
                } else
                {
                    ...
                    vector = addServers(vector, new RemoteNTInstancePreferences().getSettingName());
                }
            } else
            {
                vector = new Vector();
            ...
            if(flag1)
            {
                vector = addServers(vector, new RemoteUnixInstancePreferences().getSettingName());
            }
