...
public class perfCounterPage extends com.dragonflow.Page.CGI
{
        ...
        throws Exception
    {
        ...
        do
        {
            ...
            if(flag3)
            {
                if(s7.startsWith("("))
                {
                    ...
                    if(i != -1)
                    {
                        Integer integer = new Integer(s7.substring(1, i - 1));
                        Integer integer1 = new Integer(integer.intValue() - 1);
        ...
        {
            String s11 = com.dragonflow.SiteView.Platform.perfexCommand(s1);
            if(username.length() > 0)
            {
