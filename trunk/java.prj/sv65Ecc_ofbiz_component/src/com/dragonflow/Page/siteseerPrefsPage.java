...
import com.siteview.svecc.service.SiteSeer;
    ...
    void printForm() {
		...
		com.dragonflow.Properties.StringProperty.getPrivate(
				com.dragonflow.Utils.TextUtils.getValue(hashmap,
						"_siteseerPassword"), "siteseerPassword", "seerSuff",
				stringbuffer, stringbuffer1);
		String s1 = com.dragonflow.Utils.TextUtils.getValue(hashmap,
				"_siteseerAccount");
		String s2 = com.dragonflow.Utils.TextUtils.getValue(hashmap,
				"_siteseerHost").trim();
		if (s2.length() == 0) {
			//s2 = "siteseer5.dragonflow.com";
			s2 = SiteSeer.getDefault("_siteseerHost");
		}
		printBodyHeader("SiteSeer Preferences");
		printButtonBar("SiteSeerPref.htm", "", getSecondNavItems(request));
		printPrefsBar("SiteSeer");
		outputStream
				.println("<p><CENTER><H2>SiteSeer Preferences</H2></CENTER><p> <p>You can integrate <a href=\"http://www.dragonflow.com/products/siteseer/\"> remote monitoring data</a> into the SiteView display.  SiteView will display the status of your SiteSeer monitors as a group on the Main SiteView view and the Multi-View panel. Complete the form below  to associate a SiteSeer account with this SiteView.<FORM ACTION=/SiteView/cgi/go.exe/SiteView method=POST><input type=hidden name=account value=administrator> <input type=hidden name=page value=siteseerPrefs> <input type=hidden name=operation value=save><TABLE border=0 width=100%><TR><TD WIDTH=\"225\"></TD><TD></TD><TD WIDTH=\"50\"></TD></TR><TR><TD COLSPAN=3><HR></TD></TR><TR><TD><B><U>Required Settings</U></B></TD></TR><TR><TD ALIGN=LEFT VALIGN=TOP>SiteSeer Account: </TD><TD><input type=text name=siteseerAccount size=60 value=\""
						+ s1
						+ "\">"
						+ "<br>Enter the name of your SiteSeer account - for example, mycompany.com</TD></TR>"
						+ "<TR><TD ALIGN=LEFT VALIGN=TOP>SiteSeer Username:</TD>"
						+ "<TD> <input type=text name=siteseerUsername size=60 value=\""
						+ s
						+ "\">"
						+ "<BR>Enter the username required to login to your SiteSeer account</TD></TR>"
						+ "<TR><TD ALIGN=LEFT VALIGN=TOP>SiteSeer Password:</TD><TD>"
						+ stringbuffer.toString()
						+ " size=60>"
						+ stringbuffer1.toString()
						+ "<BR>Enter the password used to login to your SiteSeer account</TD></TR>"
						+ "<TR><TD ALIGN=LEFT VALIGN=TOP>SiteSeer Host:</TD><TD>"
						+ " <input type=text name=siteseerHost size=60 value=\""
						+ s2
						+ "\">"
						+ "<BR>Enter the host name for the SiteSeer service.  For example, <tt>siteseer3.dragonflow.com</tt> or <tt>siteseer.dragonflow.com</tt></TD></TR>"
						+ "<TR><TD></TD><TD><input type=submit value=\"Save Changes\"></TD></TR>"
						+ "<TR><TD COLSPAN=3><HR></TD></TR>");
		String s3 = com.dragonflow.Utils.TextUtils.getValue(hashmap,
				"_siteseerTitle").trim();
		if (s3.length() == 0) {
			//s3 = "Siteseer";
			s3 = SiteSeer.getDefault("_siteseerTitle");
		}
		String s4 = com.dragonflow.Utils.TextUtils.getValue(hashmap,
				"_siteseerProxy");
		String s5 = com.dragonflow.Utils.TextUtils.getValue(hashmap,
				"_siteseerProxyUsername");
		StringBuffer stringbuffer2 = new StringBuffer();
		StringBuffer stringbuffer3 = new StringBuffer();
		com.dragonflow.Properties.StringProperty.getPrivate(
				com.dragonflow.Utils.TextUtils.getValue(hashmap,
						"_siteseerProxyPassword"), "siteseerProxyPassword",
				"pSeerSuff", stringbuffer2, stringbuffer3);
		String s6 = com.dragonflow.Utils.TextUtils.getValue(hashmap,
				"_siteseerHidden");
		String s7 = com.dragonflow.Utils.TextUtils.getValue(hashmap,
				"_siteseerDisabled");
		String s8 = com.dragonflow.Utils.TextUtils.getValue(hashmap,
				"_siteseerLoginInURL");
		String s9 = com.dragonflow.Utils.TextUtils.getValue(hashmap,
				"_siteseerReadOnlyUsername");
		StringBuffer stringbuffer4 = new StringBuffer();
		StringBuffer stringbuffer5 = new StringBuffer();
		com.dragonflow.Properties.StringProperty.getPrivate(
				com.dragonflow.Utils.TextUtils.getValue(hashmap,
						"_siteseerReadOnlyPassword"),
				"siteseerReadOnlyPassword", "rSeerSuff", stringbuffer4,
				stringbuffer5);
		outputStream
				.println("<TR><TD><B><U>Advanced Options</U></B></TD></TR><TR><TD>&nbsp;</TD></TR><TR><TD ALIGN=LEFT VALIGN=TOP>Disabled:</TD><TD> <input type=checkbox value=CHECKED name=siteseerDisabled "
						+ s7
						+ ">"
						+ "Check this box to hide the SiteSeer group on the main SiteView panel</TD></TR>"
						+ "<TR><TD ALIGN=LEFT VALIGN=TOP>SiteSeer Title:</TD><TD> "
						+ "<input type=text name=siteseerTitle size=60 value=\""
						+ s3
						+ "\">"
						+ "<BR>Enter a SiteView display title for your SiteSeer account</TD></TR>"
						+ "<TR><TD ALIGN=LEFT VALIGN=TOP>SiteSeer Proxy:</TD><TD>"
						+ " <input type=text name=siteseerProxy size=60 value=\""
						+ s4
						+ "\">"
						+ "<BR>Enter proxy server name or address if use of a proxy is required to access your SiteSeer account</TD></TR>"
						+ "<TR><TD ALIGN=LEFT VALIGN=TOP>SiteSeer Proxy Username:</TD>"
						+ "<TD> <input type=text name=siteseerProxyUsername size=60 value=\""
						+ s5
						+ "\">"
						+ "<BR>Enter the proxy user name if required to access your SiteSeer account</TD></TR>"
						+ "<TR><TD ALIGN=LEFT VALIGN=TOP>SiteSeer Proxy Password:</TD><TD>"
						+ stringbuffer2.toString()
						+ " size=60>"
						+ stringbuffer3.toString()
						+ "<BR>Enter the proxy password if required to access your SiteSeer account</TD></TR>"
						+ "<TR><TD ALIGN=LEFT VALIGN=TOP>Hide SiteSeer Group:</TD><TD>"
						+ "<input type=checkbox value=CHECKED name=siteseerHidden "
						+ s6
						+ ">"
						+ "Check this box to hide the SiteSeer group on the main SiteView panel</TD></TR>"
						+ "<TR><TD ALIGN=LEFT VALIGN=TOP>Automatic SiteSeer Login:</TD><TD>"
						+ " <input type=checkbox value=CHECKED name=siteseerLoginInURL "
						+ s8
						+ ">"
						+ " Check this box to allow automatic login to SiteSeer by embedding the SiteSeer login and password in the URL</TD></TR>"
						+ " <TR><TD ALIGN=LEFT VALIGN=TOP>SiteSeer Read Only Username: </TD><TD>"
						+ "<input type=text name=siteseerReadOnlyUsername size=60 value=\""
						+ s9
						+ "\">"
						+ "<BR>Enter the user name used to login <B>read only</B> to your SiteSeer account"
						+ " - this is used for Automatic SiteSeer Login when logged into SiteView as the \"user\" user.</TD></TR>"
						+ "<TR><TD ALIGN=LEFT VALIGN=TOP>SiteSeer Read Only Password: </TD><TD>"
						+ stringbuffer4.toString()
						+ " size=60>"
						+ stringbuffer5.toString()
						+ "<BR>Enter the password used to login <B>read only</B> to your SiteSeer account</TD></TR>"
						+ "<TR><TD></TD><TD><input type=submit value=\"Save Changes\"></TD></TR>"
						+ "<TR><TD COLSPAN=3><HR></TD></TR></TABLE></FORM><br>");
		printFooter(outputStream);
	}
