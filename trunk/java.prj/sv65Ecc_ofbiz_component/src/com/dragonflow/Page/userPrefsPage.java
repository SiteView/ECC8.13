        ...
        throws Exception
    {
        ...
        if(request.isPost() && com.dragonflow.Page.treeControl.notHandled(request))
        {
            ...
            } else
            {
                ...
                if(!flag)
                {
                    for(java.util.Enumeration enumeration1 = request.getValues("_group"); enumeration1.hasMoreElements(); ((jgl.HashMap) (obj)).add("_group", com.dragonflow.HTTP.HTTPRequest.decodeString((String)enumeration1.nextElement()))) { }
                }
            }
