...
*/         
            Config.configPut("_mailServer", request.getValue("mailServer"));
            Config.configPut("_mailServerBackup", request.getValue("mailServerBackup"));
            Config.configPut("_fromAddress", com.dragonflow.Utils.TextUtils.toEmailList(request.getValue("fromAddress")));
            Config.configPut("_autoEmail", com.dragonflow.Utils.TextUtils.toEmailList(request.getValue("autoEmail")));
            Config.configPut("_autoDaily", request.getValue("autoDaily"));
            Config.configPut("_autoStartup", request.getValue("autoStartup"));
