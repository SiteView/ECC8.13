...
*/
            Config.configPut("_dailyLogKeepDays", request.getValue("dailyLogKeepDays"));
            Config.configPut("_dailyLogTotalLimit", request.getValue("dailyLogTotalLimit"));
            Config.configPut("_logJdbcPasswordSiteViewLog", com.dragonflow.Properties.StringProperty.getPrivate(request, "logJdbcPasswordSiteViewLog", "logSuff", null, null));
            Config.configPut("_logJdbcURLSiteViewLog", request.getValue("logJdbcURLSiteViewLog"));
            Config.configPut("_logJdbcURLBackupSiteViewLog", request.getValue("logJdbcURLBackupSiteViewLog"));
            Config.configPut("_logJdbcUserSiteViewLog", request.getValue("logJdbcUserSiteViewLog"));
            Config.configPut("_logJdbcDriverSiteViewLog", request.getValue("logJdbcDriverSiteViewLog"));
