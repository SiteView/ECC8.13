<form method="post"  action="submitAddMachine"  class="basic-form" onSubmit="javascript:submitFormDisableSubmits(this)">
...
<div id="_G41_"> <table cellspacing="0" class="basic-table">
  ...
  <tr>
   ...
   <td colspan="4"><select name="_os" size="1">
    ${Static["com.dragonflow.Page.machinePage"].getOptionsHTML(Static["com.dragonflow.SiteView.Machine"].getAllowedOSs(), "")}
   </select>
  ...
  <tr>
   ...
   ${Static["com.dragonflow.Page.machinePage"].getOptionsHTML(Static["com.dragonflow.SiteView.Machine"].getAllowedMethods(), "")}
   </select>
  ...
  <tr>
   ...
   <td colspan="4"><input type="text" name="_prompt" size="30"/>
  ...
  <tr>
   ...
   <td colspan="4"><input type="text" name="_loginPrompt" size="30"/>
  ...
  <tr>
   ...
   <td colspan="4"><input type="text" name="_passwordPrompt" size="30"/>
  ...
  <tr>
   ...
   <td colspan="4"><input type="text" name="_secondaryPrompt" size="30"/>
   <span class="tooltip">Secondary prompt. Separate by ',' for multiple prompts</span>
   </td>
  </tr>
  <tr>
   <td class="label">Secondary Response</td>
   <td colspan="4"><input type="text" name="_secondaryResponse" size="30"/>
  ...
  <tr>
   ...
   <td colspan="4"><input type="text" name="_initShellEnvironment" size="30"/>
  ...
  <tr>
   ...
   <td colspan="4"><input type="text" name="_encoding" size="30" value="${Static["com.dragonflow.Utils.I18N"].getDefaultEncoding()}"/>
