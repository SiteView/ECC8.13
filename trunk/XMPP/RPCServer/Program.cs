...
namespace RPCServer
{
    class Program
    {
        ...
        private static string SERVER = "server@yxd";
        ...
        static void Main(string[] args)
        {
            ...
            RPCMessageHandler.InitInstance(xmppCon);

            Console.Title = "RPC Server";

            Jid jid = new Jid(SERVER);
            ...
            RPCMessageHandler.ExitInstance();
        ...
        static void xmppCon_OnMessage(object sender, Message msg)
        {
            if (msg.Body != null)
            {
                ...
                RPCMessageHandler.ProcessMessage(msg);
            }
        }
