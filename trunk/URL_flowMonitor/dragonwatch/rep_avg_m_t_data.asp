...
If Len(Request.cookies("rep_city")("id"))>0 Then
	If Len(Request.cookies("rep_trans")("id"))>0 Then
		sql="exec yl_rep_avg_m_withid " & prof_id & "," & Request.cookies("rep_city")("id") & "," & Request.cookies("rep_trans")("id") & ",'" & startDate & "','" & endDate & "'"
	Else
		sql="exec yl_rep_avg_m_bycityid " & prof_id & "," & Request.cookies("rep_city")("id") & ",'" & startDate & "','" & endDate & "'"
	End If
Else
	sql="exec yl_rep_avg_m " & prof_id & ",'" & startDate & "','" & endDate & "'"
End If
'response.write sql
    ...
    <td colspan="3">&nbsp; <br>
      <table border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          ...
          <td width="287" align="right"><A class='bluelink' HREF="rep_avg_m_t.asp">图表</A></td>
...
ReDim arrLineSet(iCountTrans,thisMonthLength)
oldid=0
j=0
For i=0 To iRsRows
	If oldid<>CInt(arrRs(1,i)) Then
...
<table width="85%" border="0" cellspacing="1" cellpadding="3">
  <tr bgcolor="#330066" align=center>
	...
	<%
	If Len(Request.cookies("rep_city")("id"))>0 Then
		url="rep_avg_m_t_data.asp"
	Else
		url="rep_avg_m_c_data.asp"
	End If
  ...
  <%
  For i=0 To thisMonthLength
  %>
  <tr bgcolor="<%=arrColor(i mod 2)%>" align=center>
    <td><A HREF="javascript:goLink(<%=i+1%>)" style="text-decoration:underline"><%=FormatDateTime(a, vbLongDate)%></A></td>
	<%
...
function goLink(d)
{
	...
	//alert("rep_avg_d_data.asp?per=d&d="+y+"-"+m+"-"+d+" 0:00&s="+y+"-"+m+"-"+d+" 0:00&e="+y+"-"+m+"-"+d+" 23:59");
	location.href="rep_avg_d_data.asp?per=d&d="+y+"-"+m+"-"+d+" 0:00&s="+y+"-"+m+"-"+d+" 0:00&e="+y+"-"+m+"-"+d+" 23:59";
}
//-->
</SCRIPT>
