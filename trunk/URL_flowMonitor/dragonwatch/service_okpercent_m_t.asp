...
DayLength=CInt(arrLastDay(Month(startDate)-1)-1)
...
If Len(Request.cookies("rep_city")("id"))>0 Then
	If Len(Request.cookies("rep_trans")("id"))>0 then
		sql="exec cq_server_okpercent_m_t_bygroup "& prof_id & "," & Request.cookies("rep_trans")("id") & ","& Request.cookies("rep_city")("id") & ",'" & startDate & "','" & endDate & "'"
	Else
		sql="exec cq_server_okpercent_m_t_bycity "& prof_id & "," & Request.cookies("rep_city")("id") & ",'" & startDate & "','" & endDate & "'"
	End If
Else
	sql="exec cq_server_okpercent_m_t "& prof_id & ",'" & startDate & "','" & endDate & "'"
End If
''response.write sql
''response.end
      ...
      <table border="0" cellspacing="3" cellpadding="0">
        <tr>
          ...
          <td rowspan="3" width="187" align="left" valign="top" id=trans>
			...
			<%
			If Len(Request.cookies("rep_trans")("id"))>0 Then
				url="service_okpercent_m_t.asp"
			Else
				url="service_okpercent_m_c.asp"
			End If
			%>
			<%
        ...
        <tr>
          ...
          <td width="287" align="right"><A class='bluelink' HREF="service_okpercent_m_t_data.asp">数据表</A></td>
...
BottomLabels	=
<%
For i=0 to DayLength
If i=DayLength Then
	Response.Write Chr(34)&i+1&Chr(34)&";"
Else
	Response.Write Chr(34)&i+1&Chr(34)&","
End If
Next
...
<SCRIPT LANGUAGE="JavaScript" src="inc/setSelByToTranscation.js"></SCRIPT>
