...
hostid=Request("tranid")
hostname=Request("tranname")
...
'==============================================================================================================
' 计算画表所用的数据（天）
Dim i,j,k, arrRs(23), arrErr(23), sql, arrTmp, iAvg, iAvgMax, iErrMax
...
sql="exec yl_webtrace_d " & hostid & "," & cityid & ",'" & startDate & "','" & endDate & "'"
'response.write sql
'response.end
Set rs=Server.CreateObject("adodb.recordset")
rs.open sql, cnnDragon, 1, 1   ' 计算一天内各个小时的平均路由时间（毫秒）
...
rs.close
sql="exec yl_webtrace_d_error " & hostid & "," & cityid & ",'" & startDate & "','" & endDate & "'"
'response.write sql
rs.open sql, cnnDragon, 1, 1   ' 计算一天内各个小时的错误个数
