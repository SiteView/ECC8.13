...
'==============================================================================================================
' 计算画表所用的数据（小时）
Dim i,j,k, arrRs(59), arrErr(59), sql, arrTmp, iAvg, iAvgMax, iErrMax
...
sql="exec yl_webtrace_n " & hostid & "," & cityid & ",'" & startDate & "','" & endDate & "'"
'response.write sql
Set rs=Server.CreateObject("adodb.recordset")
rs.open sql, cnnDragon, 1, 1   ' 计算一小时内各分钟的平均路由时间（毫秒）
...
rs.close
sql="exec yl_webtrace_n_error " & hostid & "," & cityid & ",'" & startDate & "','" & endDate & "'"
'response.write sql
rs.open sql, cnnDragon, 1, 1   ' 计算一小时内各分钟的错误个数
