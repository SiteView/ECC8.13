...
sql = "exec cq_erranalysis_t " & prof_id & ",'" & startDate & "','" & endDate & "'"
If bFilteredCity Then sql = "exec cq_erranalysis_t_onecity " & prof_id & "," & Request.cookies("rep_city")("id") & ",'" & startDate & "','" & endDate & "'"
...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr> 
    ...
    <td width="26%" rowspan="4" valign="top"> <BR>
      <%	
...
BottomTics      = ("ON", gray, "TimesRoman", 12);
    ...
    <td colspan="2"> 
      <table width="100%" border="0" cellspacing="1" cellpadding="2" style="display:">
        <tr align="center" bgcolor="#330066"> 
          <td width="48%"><font color="#FFFFFF">业务流程</font></td>
