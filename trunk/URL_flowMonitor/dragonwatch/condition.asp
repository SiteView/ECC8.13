    ...
    <td width="94"> <div id=divBy2>
      <select name="selBy">
		...
		If Instr(Request.QueryString("n"),"error_analysis.asp")<>0  Then
			Response.write "<option value='g'>错误码</option>"
		Else
			Response.write "<option value='g'>组</option>"
		End if
		%>
      </select></div>
    </td>
