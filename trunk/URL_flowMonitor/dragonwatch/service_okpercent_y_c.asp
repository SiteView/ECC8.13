	...
	<%If bRecExists Then%>
      <table border="0" cellspacing="3" cellpadding="0">
        <tr>
          ...
          <td rowspan="3" width="187" align="left" valign="top" id=trans>
            <table cellpadding="1" width="100" cellspacing="2" border="0">
						<%
			If Len(Request.cookies("rep_city")("id"))>0 Then
				url="service_okpercent_y_c.asp"
			Else
				url="service_okpercent_y_t.asp"
			End If
			%>
        ...
        <tr>
          ...
          <td width="287" align="right"><A class='bluelink' HREF="service_okpercent_y_c_data.asp">数据表</A></td>
...
For i=1 to 12
If i=12 Then
	Response.Write Chr(34)&i&"月"&Chr(34)&";"
Else
	Response.Write Chr(34)&i&"月"&Chr(34)&","
End If
Next
...
<%If bShowLink Then%><SCRIPT LANGUAGE="JavaScript" src="inc/setSelByToGroup.js"></SCRIPT><%End If%><!-- #include file="inc/foot.asp" -->