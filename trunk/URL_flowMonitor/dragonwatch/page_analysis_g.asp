...
if Not bShowLink then Server.transfer "page_analysis_c.asp"
'******************************************************
...
If bFilteredcity then
	arrCity(0,0) = request.cookies("rep_city")("id")
	arrCity(1,0) = request.cookies("rep_city")("name")
	iCityCount = 1
End if

rs.filter = "city_id = " & arrCity(0,0)
