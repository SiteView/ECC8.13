...
%>
<frameset rows="26,*" frameborder="yes" border="1" framespacing="1" cols="*"> 
  <frame name="conditionFrame" scrolling="yes" frameborder="no" src="condition.asp?n=<%=strN%>" >
  <frame name="reportFrame" scrolling="yes" frameborder="no" src="<%=strN%>?tranid=<%=Request("hostid")%>&tranname=<%=Request("hostname")%>&cityid=<%=Request("cityid")%>&cityname=<%=Request("cityname")%>">
</frameset>
<noframes> 
