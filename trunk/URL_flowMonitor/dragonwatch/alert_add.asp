...
%>
          ...
          <td width="72%" valign="top"><fieldset style="height:90"> <legend>选择报警类型</legend> 
            <table border="0" cellspacing="2" cellpadding="0" width="480">
              <tr> 
				...
				<!-- 选择错误类型 -->
				<SELECT NAME="errcode">
				<option value="-1" selected>所有错误</option>
				<%
              ...
              <tr> 
                ...
                <td bgcolor="#EFEFDD"> 
                  <select name="alertlevel">
                    <option value="1" style="background:#000099;color:#ffffff;">轻微警告</option>
                    <option value="2" style="background:#FFcc00;color:#000000;">普通警告</option>
                    <option value="3" style="background:#FF0000;color:#ffffff;">严重警告</option>
                  </select>
                </td>
              </tr>
              <tr> 
        ...
        <tr align="center"> 
          <td colspan="2"> 
            ...
            　 
            <input type="button" value="重　填" onClick="resetfrm()">
            　 
