    ...
    <td colspan="3">&nbsp; <br>
      <table border="0" cellspacing="3" cellpadding="0">
        ...
        <tr>
          ...
          <td width="287" align="right"><A class='bluelink' HREF="rep_avg_q_t.asp">图表</A></td>
...
End Select
  ...
  <tr bgcolor="<%=arrColor(i mod 2)%>" align=center>
    <td><A HREF="rep_avg_w_t_data.asp?per=w&d=<%=x&" "&Hour(startDate)&":00"%>&s=<%=x%>&e=<%=y%>" style="text-decoration:underline"><%=(Year(x) & "年" & Month(x) & "月" & Day(x) & "日 至 " & Month(y) & "月" & Day(y) & "日")%></A></td>
	<%
