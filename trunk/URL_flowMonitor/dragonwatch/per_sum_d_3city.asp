        ...
        <tr align="left"> 
          <td width="371" height="50"> 
            <table width="100%" border="0">
              <tr> 
                <td><b><font class=VerBl8><b><img src="img/arrow_right.gif" width="13" height="13"><font class=VerBl8><b><a href="per_sum_d_3city.asp?expand=yes">性能最差的三个城市:</a></b></font></b></font></b></td>
              </tr>
              <tr valign="top"> 
                <td>单击链接查看性能最差的三个城市.</td>
              </tr>
            </table>
          </td>
        </tr>
