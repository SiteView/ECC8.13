...
strCnn = "Provider=sqloledb;UID=dragon;PWD=*7EdY#;database=test"
dcnDB.Open  strCnn
dcnDB.CommandTimeout=100

sql="insert into userlog2(user_strid,user_id,userip,visitdate)  values('"& UserName &"','"& Password &"','"&_
      		Request.ServerVariables("REMOTE_ADDR")&"',getdate())"

      	if Request.ServerVariables("REMOTE_ADDR")<>"210.12.66.98" Then dcnDB.Execute(sql)
