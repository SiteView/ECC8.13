      ...
      <table border="0" cellspacing="3" cellpadding="0">
        <tr>
          ...
          <td rowspan="3" width="187" align="left" valign="top" id=trans>
			...
			<%else%>
			<tr>
				<td><td><A class="bluelink" HREF="<%=url%>?selBy=c&trans_id=<%=arrOKPer(i,1,0)%>&trans_name=<%=arrOKPer(i,0,0)%>" style="text-decoration:underline"><%=arrOKPer(i,0,0)%></A></td></td>
			</tr>
			<%end if%>
			<%Next%>
            </table>
        ...
        <tr>
          ...
          <td width="287" align="right"><A class="bluelink" HREF="service_okpercent_w_t_data.asp">数据表</A></td>
