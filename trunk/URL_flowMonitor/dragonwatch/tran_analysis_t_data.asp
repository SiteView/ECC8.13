          ...
          <td width="840">
            <table cellspacing=1 cellpadding=3 border=0 bgcolor='#ffffff' width='100%'>
              <tr bgcolor="#330066" align="center"> 
                <td><font color="#FFFFFF"><b>业务流程名称</b></font></td>
			...
			if iRows > 0 then
				...
				For i=0 to iRows-1
					...
					sql="select * from transactionSet where trans_id = " & arrData(9,i)
					rs.open sql,cnnDragon,1,1
					...
					for j=0 to 8
						response.write "<td>&nbsp;"
						if j=0 then response.write "<a href='tran_analysis.asp?transid=" & arrData(9,i) & "&transname=" & arrData(0,i) & "#'>"   'Links
