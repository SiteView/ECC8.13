...
'==============================================================================================================
' 计算画表所用的数据（年）
Dim i,j,k, arrRs(12), arrErr(12), sql, arrTmp, iAvg, iAvgMax, iErrMax
...
sql="exec yl_webtrace_y " & hostid & "," & cityid & ",'" & startDate & "','" & endDate & "'"
'response.write sql
Set rs=Server.CreateObject("adodb.recordset")
rs.open sql, cnnDragon, 1, 1   ' 计算一年内各个月的平均路由时间（毫秒）
...
rs.close
sql="exec yl_webtrace_y_error " & hostid & "," & cityid & ",'" & startDate & "','" & endDate & "'"
'response.write sql
rs.open sql, cnnDragon, 1, 1   ' 计算一年内各个月的错误个数
