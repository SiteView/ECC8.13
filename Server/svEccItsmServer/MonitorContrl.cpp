...
#define szServiceName	"svEccItsmServer"
...
const char *g_ServiceDName="svEccItsmServer";
const char *g_ServiceName ="svEccItsmServer";
...
void  WINAPI SVS_ServiceCtrlHandler(DWORD opcode)
{
	switch(opcode)
	{
		...
		case SERVICE_CONTROL_SHUTDOWN:
			...
			rocExecuteBat(rootPath+"\\itsm\\", g_stopItsm);	// 启动 itsm目录中的 stop.bat
...
void WINAPI SVS_ServiceStart(DWORD argc, LPTSTR *argv) 
{
	...
	rocExecuteBat(rootPath+"\\itsm\\", g_startItsm);	
